...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124a:	43278793          	addi	a5,a5,1074 # 8678 <big.1273>
...
0000000000002236 <bigargtest>:
{
  ...
  close(fd);
    ...
    229e:	2de78793          	addi	a5,a5,734 # 8578 <args.1862>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3ce68693          	addi	a3,a3,974 # 8670 <args.1862+0xf8>
    ...
    22be:	2be58593          	addi	a1,a1,702 # 8578 <args.1862>
