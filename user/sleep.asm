...
main(int argc, char *argv[])
{
  ...
  2e:	7be58593          	addi	a1,a1,1982 # 7e8 <malloc+0xe6>
  32:	4509                	li	a0,2
  34:	00000097          	auipc	ra,0x0
  38:	5e2080e7          	jalr	1506(ra) # 616 <fprintf>
    exit(1);
  3c:	4505                	li	a0,1
...
free(void *ap)
{
 ...
 688:	1ac7b783          	ld	a5,428(a5) # 830 <freep>
 ...
 6b6:	00e6ea63          	bltu	a3,a4,6ca <free+0x50>
{
 ...
 6f8:	12f73e23          	sd	a5,316(a4) # 830 <freep>
}
 6fc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 72a:	10a53503          	ld	a0,266(a0) # 830 <freep>
 ...
 752:	0e290913          	addi	s2,s2,226 # 830 <freep>
  if(p == (char*)-1)
 756:	5afd                	li	s5,-1
 758:	a88d                	j	7ca <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 75a:	00000797          	auipc	a5,0x0
 75e:	0de78793          	addi	a5,a5,222 # 838 <base>
 762:	00000717          	auipc	a4,0x0
 766:	0cf73723          	sd	a5,206(a4) # 830 <freep>
 76a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 78c:	0aa73423          	sd	a0,168(a4) # 830 <freep>
      return (void*)(p + 1);
