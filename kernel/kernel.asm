...
0000000080000000 <_entry>:
    ...
    80000016:	732060ef          	jal	ra,80006748 <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	0e8080e7          	jalr	232(ra) # 80007142 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	188080e7          	jalr	392(ra) # 800071f6 <release>
}
    ...
    8000008e:	b6e080e7          	jalr	-1170(ra) # 80006bf8 <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	fbe080e7          	jalr	-66(ra) # 800070b2 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	016080e7          	jalr	22(ra) # 80007142 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	0b2080e7          	jalr	178(ra) # 800071f6 <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	088080e7          	jalr	136(ra) # 800071f6 <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000348:	f10080e7          	jalr	-240(ra) # 80007254 <lockfree_read4>
    ...
    80000368:	8de080e7          	jalr	-1826(ra) # 80006c42 <printf>
  ...
  scheduler();        
    ...
    80000430:	21c080e7          	jalr	540(ra) # 80006648 <pci_init>
    sockinit();
    80000434:	00006097          	auipc	ra,0x6
    80000438:	e0a080e7          	jalr	-502(ra) # 8000623e <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004aa:	752080e7          	jalr	1874(ra) # 80006bf8 <panic>
...
0000000080000600 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000062c:	5d0080e7          	jalr	1488(ra) # 80006bf8 <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008ca:	332080e7          	jalr	818(ra) # 80006bf8 <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    80000a0c:	1f0080e7          	jalr	496(ra) # 80006bf8 <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b62:	09a080e7          	jalr	154(ra) # 80006bf8 <panic>
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dc2:	e3a080e7          	jalr	-454(ra) # 80006bf8 <panic>
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000dee:	2c8080e7          	jalr	712(ra) # 800070b2 <initlock>
  initlock(&wait_lock, "wait_lock");
    ...
    80000e06:	2b0080e7          	jalr	688(ra) # 800070b2 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e3c:	27a080e7          	jalr	634(ra) # 800070b2 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000eae:	24c080e7          	jalr	588(ra) # 800070f6 <push_off>
  ...
  pop_off();
    ...
    80000ec8:	2d2080e7          	jalr	722(ra) # 80007196 <pop_off>
  return p;
}
...
forkret(void)
{
  ...
  release(&myproc()->lock);
    ...
    80000eec:	30e080e7          	jalr	782(ra) # 800071f6 <release>
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f38:	20e080e7          	jalr	526(ra) # 80007142 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000f52:	2a8080e7          	jalr	680(ra) # 800071f6 <release>
}
...
00000000800010aa <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010cc:	07a080e7          	jalr	122(ra) # 80007142 <acquire>
    if(p->state == UNUSED) {
    ...
    800010da:	120080e7          	jalr	288(ra) # 800071f6 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    80001158:	0a2080e7          	jalr	162(ra) # 800071f6 <release>
    return 0;
    ...
    80001170:	08a080e7          	jalr	138(ra) # 800071f6 <release>
    return 0;
...
0000000080001178 <userinit>:
{
  ...
  release(&p->lock);
    ...
    800011ec:	00e080e7          	jalr	14(ra) # 800071f6 <release>
}
...
000000008000126e <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001304:	ef6080e7          	jalr	-266(ra) # 800071f6 <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001356:	ea4080e7          	jalr	-348(ra) # 800071f6 <release>
  acquire(&wait_lock);
    ...
    80001368:	dde080e7          	jalr	-546(ra) # 80007142 <acquire>
  np->parent = p;
    8000136c:	0329bc23          	sd	s2,56(s3)
  release(&wait_lock);
    80001370:	8526                	mv	a0,s1
    80001372:	00006097          	auipc	ra,0x6
    80001376:	e84080e7          	jalr	-380(ra) # 800071f6 <release>
  acquire(&np->lock);
    8000137a:	854e                	mv	a0,s3
    8000137c:	00006097          	auipc	ra,0x6
    80001380:	dc6080e7          	jalr	-570(ra) # 80007142 <acquire>
  np->state = RUNNABLE;
  ...
  release(&np->lock);
    ...
    80001390:	e6a080e7          	jalr	-406(ra) # 800071f6 <release>
}
...
00000000800013aa <scheduler>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    8000142c:	dce080e7          	jalr	-562(ra) # 800071f6 <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000143e:	d08080e7          	jalr	-760(ra) # 80007142 <acquire>
      if(p->state == RUNNABLE) {
...
000000008000144a <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    80001466:	c66080e7          	jalr	-922(ra) # 800070c8 <holding>
...
0000000080001520 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    80001538:	c0e080e7          	jalr	-1010(ra) # 80007142 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    8000154e:	cac080e7          	jalr	-852(ra) # 800071f6 <release>
}
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  acquire(&p->lock);  //DOC: sleeplock1
    ...
    8000157c:	bca080e7          	jalr	-1078(ra) # 80007142 <acquire>
  release(lk);
    80001580:	854a                	mv	a0,s2
    80001582:	00006097          	auipc	ra,0x6
    80001586:	c74080e7          	jalr	-908(ra) # 800071f6 <release>
  ...
  release(&p->lock);
    ...
    800015a4:	c56080e7          	jalr	-938(ra) # 800071f6 <release>
  acquire(lk);
    800015a8:	854a                	mv	a0,s2
    800015aa:	00006097          	auipc	ra,0x6
    800015ae:	b98080e7          	jalr	-1128(ra) # 80007142 <acquire>
}
...
00000000800015c0 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800015f0:	b56080e7          	jalr	-1194(ra) # 80007142 <acquire>
    havekids = 0;
    ...
    8000168e:	ab8080e7          	jalr	-1352(ra) # 80007142 <acquire>
        if(np->state == ZOMBIE){
    ...
    8000169e:	b5c080e7          	jalr	-1188(ra) # 800071f6 <release>
        havekids = 1;
    ...
    800016ba:	b40080e7          	jalr	-1216(ra) # 800071f6 <release>
      return -1;
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000171c:	ade080e7          	jalr	-1314(ra) # 800071f6 <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000173a:	a0c080e7          	jalr	-1524(ra) # 80007142 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
...
00000000800017b8 <exit>:
{
  ...
  if(p == initproc)
    ...
    800017f4:	408080e7          	jalr	1032(ra) # 80006bf8 <panic>
      fileclose(f);
  ...
  acquire(&wait_lock);
    ...
    8000183e:	908080e7          	jalr	-1784(ra) # 80007142 <acquire>
  reparent(p);
  ...
  acquire(&p->lock);
    ...
    8000185e:	8e8080e7          	jalr	-1816(ra) # 80007142 <acquire>
  p->xstate = status;
  ...
  release(&wait_lock);
    ...
    80001872:	988080e7          	jalr	-1656(ra) # 800071f6 <release>
  sched();
  ...
  panic("zombie exit");
    ...
    8000188a:	372080e7          	jalr	882(ra) # 80006bf8 <panic>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018b4:	892080e7          	jalr	-1902(ra) # 80007142 <acquire>
    if(p->pid == pid){
    ...
    800018c4:	936080e7          	jalr	-1738(ra) # 800071f6 <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    800018e6:	914080e7          	jalr	-1772(ra) # 800071f6 <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800019ce:	278080e7          	jalr	632(ra) # 80006c42 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a10:	236080e7          	jalr	566(ra) # 80006c42 <printf>
    printf("\n");
    80001a14:	8552                	mv	a0,s4
    80001a16:	00005097          	auipc	ra,0x5
    80001a1a:	22c080e7          	jalr	556(ra) # 80006c42 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ae0:	5d6080e7          	jalr	1494(ra) # 800070b2 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bba:	58c080e7          	jalr	1420(ra) # 80007142 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001bda:	620080e7          	jalr	1568(ra) # 800071f6 <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c4a:	ffc080e7          	jalr	-4(ra) # 80006c42 <printf>
    80001c4e:	a029                	j	80001c58 <devintr+0x70>
      uartintr();
    80001c50:	00005097          	auipc	ra,0x5
    80001c54:	412080e7          	jalr	1042(ra) # 80007062 <uartintr>
      plic_complete(irq);
    ...
    80001c74:	d6a080e7          	jalr	-662(ra) # 800059da <e1000_intr>
...
0000000080001c9c <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001cee:	56a080e7          	jalr	1386(ra) # 80007254 <lockfree_read4>
    ...
    80001d02:	efa080e7          	jalr	-262(ra) # 80006bf8 <panic>
    if(lockfree_read4(&p->killed))
    80001d06:	02850513          	addi	a0,a0,40
    80001d0a:	00005097          	auipc	ra,0x5
    80001d0e:	54a080e7          	jalr	1354(ra) # 80007254 <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d38:	520080e7          	jalr	1312(ra) # 80007254 <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001d82:	ec4080e7          	jalr	-316(ra) # 80006c42 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001d9a:	eac080e7          	jalr	-340(ra) # 80006c42 <printf>
    p->killed = 1;
...
0000000080001dae <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e08:	df4080e7          	jalr	-524(ra) # 80006bf8 <panic>
    ...
    80001e18:	de4080e7          	jalr	-540(ra) # 80006bf8 <panic>
    printf("scause %p\n", scause);
    ...
    80001e2a:	e1c080e7          	jalr	-484(ra) # 80006c42 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001ede:	d1e080e7          	jalr	-738(ra) # 80006bf8 <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002046:	c00080e7          	jalr	-1024(ra) # 80006c42 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    8000216c:	fda080e7          	jalr	-38(ra) # 80007142 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021c0:	03a080e7          	jalr	58(ra) # 800071f6 <release>
  return 0;
    ...
    800021e2:	018080e7          	jalr	24(ra) # 800071f6 <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002232:	f14080e7          	jalr	-236(ra) # 80007142 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000224a:	fb0080e7          	jalr	-80(ra) # 800071f6 <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002282:	e34080e7          	jalr	-460(ra) # 800070b2 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000230a:	e3c080e7          	jalr	-452(ra) # 80007142 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000234a:	eb0080e7          	jalr	-336(ra) # 800071f6 <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    80002388:	874080e7          	jalr	-1932(ra) # 80006bf8 <panic>
      b->dev = dev;
    ...
    800023a8:	e52080e7          	jalr	-430(ra) # 800071f6 <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002418:	7e4080e7          	jalr	2020(ra) # 80006bf8 <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002450:	cf6080e7          	jalr	-778(ra) # 80007142 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    8000249a:	d60080e7          	jalr	-672(ra) # 800071f6 <release>
}
    ...
    800024b6:	746080e7          	jalr	1862(ra) # 80006bf8 <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d2:	c74080e7          	jalr	-908(ra) # 80007142 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    800024e8:	d12080e7          	jalr	-750(ra) # 800071f6 <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000250e:	c38080e7          	jalr	-968(ra) # 80007142 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002524:	cd6080e7          	jalr	-810(ra) # 800071f6 <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025aa:	652080e7          	jalr	1618(ra) # 80006bf8 <panic>
...
00000000800025ae <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    80002670:	58c080e7          	jalr	1420(ra) # 80006bf8 <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027b6:	446080e7          	jalr	1094(ra) # 80006bf8 <panic>
...
00000000800027ba <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800027da:	96c080e7          	jalr	-1684(ra) # 80007142 <acquire>
  empty = 0;
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80002820:	9da080e7          	jalr	-1574(ra) # 800071f6 <release>
      return ip;
  ...
  release(&itable.lock);
    ...
    80002850:	9aa080e7          	jalr	-1622(ra) # 800071f6 <release>
}
    ...
    80002872:	38a080e7          	jalr	906(ra) # 80006bf8 <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    800028f2:	30a080e7          	jalr	778(ra) # 80006bf8 <panic>
...
00000000800028f6 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80002918:	79e080e7          	jalr	1950(ra) # 800070b2 <initlock>
  for(i = 0; i < NINODE; i++) {
...
0000000080002956 <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    800029d6:	226080e7          	jalr	550(ra) # 80006bf8 <panic>
...
0000000080002ab0 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80002ac8:	67e080e7          	jalr	1662(ra) # 80007142 <acquire>
  ip->ref++;
  ...
  release(&itable.lock);
    ...
    80002ade:	71c080e7          	jalr	1820(ra) # 800071f6 <release>
}
...
0000000080002aee <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b2a:	0d2080e7          	jalr	210(ra) # 80006bf8 <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002bac:	050080e7          	jalr	80(ra) # 80006bf8 <panic>
...
0000000080002bb0 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002bf8:	004080e7          	jalr	4(ra) # 80006bf8 <panic>
...
0000000080002ca8 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80002cc2:	484080e7          	jalr	1156(ra) # 80007142 <acquire>
  ...
  release(&itable.lock);
    ...
    80002ce0:	51a080e7          	jalr	1306(ra) # 800071f6 <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d14:	4e6080e7          	jalr	1254(ra) # 800071f6 <release>
    itrunc(ip);
    ...
    80002d4a:	3fc080e7          	jalr	1020(ra) # 80007142 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003008:	bf4080e7          	jalr	-1036(ra) # 80006bf8 <panic>
    ...
    80003018:	be4080e7          	jalr	-1052(ra) # 80006bf8 <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
000000008000341c <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003444:	c72080e7          	jalr	-910(ra) # 800070b2 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800034d8:	c6e080e7          	jalr	-914(ra) # 80007142 <acquire>
  while(1){
    if(log.committing){
    ...
    80003530:	cca080e7          	jalr	-822(ra) # 800071f6 <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003560:	be6080e7          	jalr	-1050(ra) # 80007142 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    80003588:	c72080e7          	jalr	-910(ra) # 800071f6 <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035a0:	ba6080e7          	jalr	-1114(ra) # 80007142 <acquire>
    log.committing = 0;
    ...
    800035b8:	c42080e7          	jalr	-958(ra) # 800071f6 <release>
}
    ...
    800035da:	622080e7          	jalr	1570(ra) # 80006bf8 <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    800035f6:	c04080e7          	jalr	-1020(ra) # 800071f6 <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800036b4:	a92080e7          	jalr	-1390(ra) # 80007142 <acquire>
  ...
  release(&log.lock);
    ...
    8000376e:	a8c080e7          	jalr	-1396(ra) # 800071f6 <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    8000379c:	91a080e7          	jalr	-1766(ra) # 800070b2 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800037d0:	976080e7          	jalr	-1674(ra) # 80007142 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    800037fe:	9fc080e7          	jalr	-1540(ra) # 800071f6 <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003826:	920080e7          	jalr	-1760(ra) # 80007142 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    80003842:	9b8080e7          	jalr	-1608(ra) # 800071f6 <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000386c:	8da080e7          	jalr	-1830(ra) # 80007142 <acquire>
  ...
  release(&lk->lk);
    ...
    8000387c:	97e080e7          	jalr	-1666(ra) # 800071f6 <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800038c4:	7f2080e7          	jalr	2034(ra) # 800070b2 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038e6:	860080e7          	jalr	-1952(ra) # 80007142 <acquire>
  ...
  release(&ftable.lock);
    ...
    80003912:	8e8080e7          	jalr	-1816(ra) # 800071f6 <release>
  return 0;
    ...
    8000392a:	8d0080e7          	jalr	-1840(ra) # 800071f6 <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003952:	7f4080e7          	jalr	2036(ra) # 80007142 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    8000396c:	88e080e7          	jalr	-1906(ra) # 800071f6 <release>
  return f;
}
    ...
    80003988:	274080e7          	jalr	628(ra) # 80006bf8 <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ae:	798080e7          	jalr	1944(ra) # 80007142 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039ec:	80e080e7          	jalr	-2034(ra) # 800071f6 <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a0c:	984080e7          	jalr	-1660(ra) # 8000638c <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b1c:	904080e7          	jalr	-1788(ra) # 8000641c <sockread>
  ...
  return r;
    ...
    80003ba8:	054080e7          	jalr	84(ra) # 80006bf8 <panic>
    return -1;
    ...
    80003bbc:	12078263          	beqz	a5,80003ce0 <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bfe:	8f2080e7          	jalr	-1806(ra) # 800064ec <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003cdc:	f20080e7          	jalr	-224(ra) # 80006bf8 <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d4c:	36a080e7          	jalr	874(ra) # 800070b2 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003dda:	36c080e7          	jalr	876(ra) # 80007142 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003dfe:	3fc080e7          	jalr	1020(ra) # 800071f6 <release>
    kfree((char*)pi);
    ...
    80003e30:	3ca080e7          	jalr	970(ra) # 800071f6 <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003e66:	2e0080e7          	jalr	736(ra) # 80007142 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003e84:	376080e7          	jalr	886(ra) # 800071f6 <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f26:	2d4080e7          	jalr	724(ra) # 800071f6 <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f5c:	1ea080e7          	jalr	490(ra) # 80007142 <acquire>
  ...
  release(&pi->lock);
    ...
    80003ff0:	20a080e7          	jalr	522(ra) # 800071f6 <release>
  return i;
}
    ...
    80004010:	1ea080e7          	jalr	490(ra) # 800071f6 <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004118:	ae4080e7          	jalr	-1308(ra) # 80006bf8 <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000454a:	6b2080e7          	jalr	1714(ra) # 80006bf8 <panic>
    dp->nlink++;  // for ".."
...
00000000800048b8 <sys_unlink>:
{
  ...
  return 0;
    ...
    800049e4:	218080e7          	jalr	536(ra) # 80006bf8 <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    80005022:	248080e7          	jalr	584(ra) # 80006266 <sockalloc>
...
000000008000527c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    8000529a:	e1c080e7          	jalr	-484(ra) # 800070b2 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    8000539c:	860080e7          	jalr	-1952(ra) # 80006bf8 <panic>
    ...
    800053ac:	850080e7          	jalr	-1968(ra) # 80006bf8 <panic>
    ...
    800053bc:	840080e7          	jalr	-1984(ra) # 80006bf8 <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053fa:	d4c080e7          	jalr	-692(ra) # 80007142 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005634:	bc6080e7          	jalr	-1082(ra) # 800071f6 <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056ae:	a98080e7          	jalr	-1384(ra) # 80007142 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005740:	aba080e7          	jalr	-1350(ra) # 800071f6 <release>
}
    ...
    8000575c:	4a0080e7          	jalr	1184(ra) # 80006bf8 <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    80005784:	932080e7          	jalr	-1742(ra) # 800070b2 <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000583e:	446080e7          	jalr	1094(ra) # 80005c80 <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005900:	2fc080e7          	jalr	764(ra) # 80006bf8 <panic>
...
e1000_transmit(struct mbuf *m)
{
  ...
  //
  acquire(&e1000_lock);   // acquire the lock
    ...
    80005922:	824080e7          	jalr	-2012(ra) # 80007142 <acquire>
  int index = regs[E1000_TDT]; // get the current ring position using E1000_TDT 
    ...
    80005932:	8187a483          	lw	s1,-2024(a5)
    80005936:	2481                	sext.w	s1,s1
  if (!(tx_ring[index].status & E1000_TXD_STAT_DD)) {  // if the previous transmission is not done 
    80005938:	00449793          	slli	a5,s1,0x4
    8000593c:	99be                	add	s3,s3,a5
    8000593e:	02c9c783          	lbu	a5,44(s3)
    80005942:	8b85                	andi	a5,a5,1
    80005944:	c3c9                	beqz	a5,800059c6 <e1000_transmit+0xc2>
    release(&e1000_lock);                              // release the lock and return an error
    return -1;
  }
  if (tx_mbufs[index] != 0)   // If previous mbuf was not free use mbuffree to free it
    80005946:	00349713          	slli	a4,s1,0x3
    8000594a:	00019797          	auipc	a5,0x19
    8000594e:	6b678793          	addi	a5,a5,1718 # 8001f000 <e1000_lock>
    80005952:	97ba                	add	a5,a5,a4
    80005954:	1207b503          	ld	a0,288(a5)
    80005958:	c509                	beqz	a0,80005962 <e1000_transmit+0x5e>
    mbuffree(tx_mbufs[index]);
    8000595a:	00000097          	auipc	ra,0x0
    8000595e:	37e080e7          	jalr	894(ra) # 80005cd8 <mbuffree>

  tx_ring[index].addr = (uint64) m->head; // load descriptor with addr and length and necessary cmds
    80005962:	00019517          	auipc	a0,0x19
    80005966:	69e50513          	addi	a0,a0,1694 # 8001f000 <e1000_lock>
    8000596a:	00449793          	slli	a5,s1,0x4
    8000596e:	97aa                	add	a5,a5,a0
    80005970:	00893703          	ld	a4,8(s2)
    80005974:	f398                	sd	a4,32(a5)
  tx_ring[index].length = (uint16) m->len;
    80005976:	01092703          	lw	a4,16(s2)
    8000597a:	02e79423          	sh	a4,40(a5)
  tx_ring[index].cmd = E1000_TXD_CMD_EOP | E1000_TXD_CMD_RS;
    8000597e:	4725                	li	a4,9
    80005980:	02e785a3          	sb	a4,43(a5)

  tx_mbufs[index] = m;   // stashing a pointer to mbuf 
    80005984:	00349793          	slli	a5,s1,0x3
    80005988:	97aa                	add	a5,a5,a0
    8000598a:	1327b023          	sd	s2,288(a5)
  regs[E1000_TDT] = (index + 1) % TX_RING_SIZE; // update the index where next packet is supposed to be stored
    8000598e:	2485                	addiw	s1,s1,1
    80005990:	41f4d79b          	sraiw	a5,s1,0x1f
    80005994:	01c7d79b          	srliw	a5,a5,0x1c
    80005998:	9cbd                	addw	s1,s1,a5
    8000599a:	88bd                	andi	s1,s1,15
    8000599c:	9c9d                	subw	s1,s1,a5
    8000599e:	00004797          	auipc	a5,0x4
    800059a2:	6827b783          	ld	a5,1666(a5) # 8000a020 <regs>
    800059a6:	6711                	lui	a4,0x4
    800059a8:	97ba                	add	a5,a5,a4
    800059aa:	8097ac23          	sw	s1,-2024(a5)
  release(&e1000_lock);
    800059ae:	00002097          	auipc	ra,0x2
    800059b2:	848080e7          	jalr	-1976(ra) # 800071f6 <release>
  ...
  return 0;
    ...
    800059c0:	69a2                	ld	s3,8(sp)
    800059c2:	6145                	addi	sp,sp,48
    800059c4:	8082                	ret
    release(&e1000_lock);                              // release the lock and return an error
    800059c6:	00019517          	auipc	a0,0x19
    800059ca:	63a50513          	addi	a0,a0,1594 # 8001f000 <e1000_lock>
    800059ce:	00002097          	auipc	ra,0x2
    800059d2:	828080e7          	jalr	-2008(ra) # 800071f6 <release>
    return -1;
    800059d6:	557d                	li	a0,-1
    800059d8:	b7c5                	j	800059b8 <e1000_transmit+0xb4>

00000000800059da <e1000_intr>:
  release(&e1000_lock);
}
...
e1000_intr(void)
{
    ...
    800059e2:	f04a                	sd	s2,32(sp)
    800059e4:	ec4e                	sd	s3,24(sp)
    800059e6:	e852                	sd	s4,16(sp)
    800059e8:	e456                	sd	s5,8(sp)
  ...
  regs[E1000_ICR] = 0xffffffff;
    ...
    800059f0:	63448493          	addi	s1,s1,1588 # 8000a020 <regs>
    800059f4:	609c                	ld	a5,0(s1)
    800059f6:	577d                	li	a4,-1
    800059f8:	0ce7a023          	sw	a4,192(a5)
  acquire(&e1000_lock);   // acquire the lock
    800059fc:	00019917          	auipc	s2,0x19
    80005a00:	60490913          	addi	s2,s2,1540 # 8001f000 <e1000_lock>
    80005a04:	854a                	mv	a0,s2
    80005a06:	00001097          	auipc	ra,0x1
    80005a0a:	73c080e7          	jalr	1852(ra) # 80007142 <acquire>
  int index = (regs[E1000_RDT] +1) % RX_RING_SIZE ;
    80005a0e:	609c                	ld	a5,0(s1)
    80005a10:	670d                	lui	a4,0x3
    80005a12:	97ba                	add	a5,a5,a4
    80005a14:	8187a483          	lw	s1,-2024(a5)
    80005a18:	2485                	addiw	s1,s1,1
    80005a1a:	88bd                	andi	s1,s1,15
  while ((rx_ring[index].status & E1000_RXD_STAT_DD)!=0) {  // if the previous transmission is not done 
    80005a1c:	00449793          	slli	a5,s1,0x4
    80005a20:	993e                	add	s2,s2,a5
    80005a22:	1ac94783          	lbu	a5,428(s2)
    80005a26:	8b85                	andi	a5,a5,1
    80005a28:	c3c9                	beqz	a5,80005aaa <e1000_intr+0xd0>
  uint16 len= rx_ring[index].length;
    80005a2a:	00019997          	auipc	s3,0x19
    80005a2e:	5d698993          	addi	s3,s3,1494 # 8001f000 <e1000_lock>
  regs[E1000_RDT] = index;
    80005a32:	00004a97          	auipc	s5,0x4
    80005a36:	5eea8a93          	addi	s5,s5,1518 # 8000a020 <regs>
    80005a3a:	6a0d                	lui	s4,0x3
  uint16 len= rx_ring[index].length;
    80005a3c:	00449793          	slli	a5,s1,0x4
    80005a40:	97ce                	add	a5,a5,s3
  mbufput(rx_mbufs[index], len);
    80005a42:	00349913          	slli	s2,s1,0x3
    80005a46:	994e                	add	s2,s2,s3
    80005a48:	1a87d583          	lhu	a1,424(a5)
    80005a4c:	2a093503          	ld	a0,672(s2)
    80005a50:	00000097          	auipc	ra,0x0
    80005a54:	1d4080e7          	jalr	468(ra) # 80005c24 <mbufput>
  release(&e1000_lock);
    80005a58:	854e                	mv	a0,s3
    80005a5a:	00001097          	auipc	ra,0x1
    80005a5e:	79c080e7          	jalr	1948(ra) # 800071f6 <release>
  net_rx(rx_mbufs[index]);
    80005a62:	2a093503          	ld	a0,672(s2)
    80005a66:	00000097          	auipc	ra,0x0
    80005a6a:	3e6080e7          	jalr	998(ra) # 80005e4c <net_rx>
  acquire(&e1000_lock);
    80005a6e:	854e                	mv	a0,s3
    80005a70:	00001097          	auipc	ra,0x1
    80005a74:	6d2080e7          	jalr	1746(ra) # 80007142 <acquire>
  rx_mbufs[index] = mbufalloc(0);
    80005a78:	4501                	li	a0,0
    80005a7a:	00000097          	auipc	ra,0x0
    80005a7e:	206080e7          	jalr	518(ra) # 80005c80 <mbufalloc>
    80005a82:	2aa93023          	sd	a0,672(s2)
    if (!rx_mbufs[index]){
    80005a86:	c139                	beqz	a0,80005acc <e1000_intr+0xf2>
  regs[E1000_RDT] = index;
    80005a88:	000ab783          	ld	a5,0(s5)
    80005a8c:	2481                	sext.w	s1,s1
    80005a8e:	97d2                	add	a5,a5,s4
    80005a90:	8097ac23          	sw	s1,-2024(a5)
  index = (regs[E1000_RDT] +1) % RX_RING_SIZE ;
    80005a94:	8187a483          	lw	s1,-2024(a5)
    80005a98:	2485                	addiw	s1,s1,1
    80005a9a:	88bd                	andi	s1,s1,15
  while ((rx_ring[index].status & E1000_RXD_STAT_DD)!=0) {  // if the previous transmission is not done 
    80005a9c:	00449793          	slli	a5,s1,0x4
    80005aa0:	97ce                	add	a5,a5,s3
    80005aa2:	1ac7c783          	lbu	a5,428(a5)
    80005aa6:	8b85                	andi	a5,a5,1
    80005aa8:	fbd1                	bnez	a5,80005a3c <e1000_intr+0x62>
  release(&e1000_lock);
    80005aaa:	00019517          	auipc	a0,0x19
    80005aae:	55650513          	addi	a0,a0,1366 # 8001f000 <e1000_lock>
    80005ab2:	00001097          	auipc	ra,0x1
    80005ab6:	744080e7          	jalr	1860(ra) # 800071f6 <release>

  e1000_recv();
}
    80005aba:	70e2                	ld	ra,56(sp)
    80005abc:	7442                	ld	s0,48(sp)
    80005abe:	74a2                	ld	s1,40(sp)
    80005ac0:	7902                	ld	s2,32(sp)
    80005ac2:	69e2                	ld	s3,24(sp)
    80005ac4:	6a42                	ld	s4,16(sp)
    80005ac6:	6aa2                	ld	s5,8(sp)
    80005ac8:	6121                	addi	sp,sp,64
    80005aca:	8082                	ret
      panic("e1000");
    80005acc:	00004517          	auipc	a0,0x4
    80005ad0:	d1450513          	addi	a0,a0,-748 # 800097e0 <syscalls+0x408>
    80005ad4:	00001097          	auipc	ra,0x1
    80005ad8:	124080e7          	jalr	292(ra) # 80006bf8 <panic>

0000000080005adc <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005ade:	ec22                	sd	s0,24(sp)
    80005ae0:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005ae2:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005ae8:	04b7d963          	bge	a5,a1,80005b3a <in_cksum+0x5e>
    80005aec:	ffe5879b          	addiw	a5,a1,-2
    80005af0:	0017d61b          	srliw	a2,a5,0x1
    80005af4:	0017d71b          	srliw	a4,a5,0x1
    80005af8:	0705                	addi	a4,a4,1
    80005afa:	0706                	slli	a4,a4,0x1
    80005afc:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005afe:	4781                	li	a5,0
    sum += *w++;
    80005b00:	0509                	addi	a0,a0,2
    80005b02:	ffe55683          	lhu	a3,-2(a0)
    80005b06:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005b08:	fee51ce3          	bne	a0,a4,80005b00 <in_cksum+0x24>
    80005b0c:	35f9                	addiw	a1,a1,-2
    80005b0e:	0016169b          	slliw	a3,a2,0x1
    80005b12:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }
  ...
  if (nleft == 1) {
    ...
    80005b16:	02d58563          	beq	a1,a3,80005b40 <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005b1a:	03079513          	slli	a0,a5,0x30
    80005b1e:	9141                	srli	a0,a0,0x30
    80005b20:	0107d79b          	srliw	a5,a5,0x10
    80005b24:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005b26:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005b2a:	9d3d                	addw	a0,a0,a5
    80005b2c:	fff54513          	not	a0,a0
  return answer;
}
    80005b30:	1542                	slli	a0,a0,0x30
    80005b32:	9141                	srli	a0,a0,0x30
    80005b34:	6462                	ld	s0,24(sp)
    80005b36:	6105                	addi	sp,sp,32
    80005b38:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b3a:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b3c:	4781                	li	a5,0
    80005b3e:	bfd9                	j	80005b14 <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b40:	00074703          	lbu	a4,0(a4) # 3000 <_entry-0x7fffd000>
    80005b44:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b48:	fee45703          	lhu	a4,-18(s0)
    80005b4c:	9fb9                	addw	a5,a5,a4
    80005b4e:	b7f1                	j	80005b1a <in_cksum+0x3e>

0000000080005b50 <mbufpull>:
{
    80005b50:	1141                	addi	sp,sp,-16
    80005b52:	e422                	sd	s0,8(sp)
    80005b54:	0800                	addi	s0,sp,16
    80005b56:	87aa                	mv	a5,a0
  char *tmp = m->head;
    80005b58:	6508                	ld	a0,8(a0)
  if (m->len < len)
    80005b5a:	4b98                	lw	a4,16(a5)
    80005b5c:	00b76b63          	bltu	a4,a1,80005b72 <mbufpull+0x22>
  m->len -= len;
    80005b60:	9f0d                	subw	a4,a4,a1
    80005b62:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b64:	1582                	slli	a1,a1,0x20
    80005b66:	9181                	srli	a1,a1,0x20
    80005b68:	95aa                	add	a1,a1,a0
    80005b6a:	e78c                	sd	a1,8(a5)
}
    80005b6c:	6422                	ld	s0,8(sp)
    80005b6e:	0141                	addi	sp,sp,16
    80005b70:	8082                	ret
    return 0;
    80005b72:	4501                	li	a0,0
    80005b74:	bfe5                	j	80005b6c <mbufpull+0x1c>

0000000080005b76 <mbufpush>:
{
    80005b76:	87aa                	mv	a5,a0
  m->head -= len;
    80005b78:	02059713          	slli	a4,a1,0x20
    80005b7c:	9301                	srli	a4,a4,0x20
    80005b7e:	6508                	ld	a0,8(a0)
    80005b80:	8d19                	sub	a0,a0,a4
    80005b82:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005b84:	01478713          	addi	a4,a5,20
    80005b88:	00e56663          	bltu	a0,a4,80005b94 <mbufpush+0x1e>
  m->len += len;
    80005b8c:	4b98                	lw	a4,16(a5)
    80005b8e:	9db9                	addw	a1,a1,a4
    80005b90:	cb8c                	sw	a1,16(a5)
}
    80005b92:	8082                	ret
{
    ...
    80005ba0:	c4c50513          	addi	a0,a0,-948 # 800097e8 <syscalls+0x410>
    80005ba4:	00001097          	auipc	ra,0x1
    80005ba8:	054080e7          	jalr	84(ra) # 80006bf8 <panic>

0000000080005bac <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    ...
    80005bb2:	ec26                	sd	s1,24(sp)
    80005bb4:	e84a                	sd	s2,16(sp)
    80005bb6:	e44e                	sd	s3,8(sp)
    80005bb8:	1800                	addi	s0,sp,48
    80005bba:	89aa                	mv	s3,a0
    80005bbc:	892e                	mv	s2,a1
  struct eth *ethhdr;

  ethhdr = mbufpushhdr(m, *ethhdr);
    80005bbe:	45b9                	li	a1,14
    80005bc0:	00000097          	auipc	ra,0x0
    80005bc4:	fb6080e7          	jalr	-74(ra) # 80005b76 <mbufpush>
    80005bc8:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005bca:	4619                	li	a2,6
    80005bcc:	00004597          	auipc	a1,0x4
    80005bd0:	cd458593          	addi	a1,a1,-812 # 800098a0 <local_mac>
    80005bd4:	0519                	addi	a0,a0,6
    80005bd6:	ffffa097          	auipc	ra,0xffffa
    80005bda:	602080e7          	jalr	1538(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005bde:	4619                	li	a2,6
    80005be0:	00004597          	auipc	a1,0x4
    80005be4:	cb858593          	addi	a1,a1,-840 # 80009898 <broadcast_mac>
    80005be8:	8526                	mv	a0,s1
    80005bea:	ffffa097          	auipc	ra,0xffffa
    80005bee:	5ee080e7          	jalr	1518(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005bf2:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005bf6:	00f48623          	sb	a5,12(s1)
    80005bfa:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005bfe:	854e                	mv	a0,s3
    80005c00:	00000097          	auipc	ra,0x0
    80005c04:	d04080e7          	jalr	-764(ra) # 80005904 <e1000_transmit>
    80005c08:	e901                	bnez	a0,80005c18 <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
    80005c0a:	70a2                	ld	ra,40(sp)
    80005c0c:	7402                	ld	s0,32(sp)
    80005c0e:	64e2                	ld	s1,24(sp)
    80005c10:	6942                	ld	s2,16(sp)
    80005c12:	69a2                	ld	s3,8(sp)
    80005c14:	6145                	addi	sp,sp,48
    80005c16:	8082                	ret
  kfree(m);
    80005c18:	854e                	mv	a0,s3
    80005c1a:	ffffa097          	auipc	ra,0xffffa
    80005c1e:	402080e7          	jalr	1026(ra) # 8000001c <kfree>
}
    80005c22:	b7e5                	j	80005c0a <net_tx_eth+0x5e>

0000000080005c24 <mbufput>:
{
    80005c24:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005c26:	4918                	lw	a4,16(a0)
    80005c28:	02071693          	slli	a3,a4,0x20
    80005c2c:	9281                	srli	a3,a3,0x20
    80005c2e:	6508                	ld	a0,8(a0)
    80005c30:	9536                	add	a0,a0,a3
  m->len += len;
    80005c32:	9f2d                	addw	a4,a4,a1
    80005c34:	0007069b          	sext.w	a3,a4
    80005c38:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c3a:	6785                	lui	a5,0x1
    80005c3c:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c40:	00d7e363          	bltu	a5,a3,80005c46 <mbufput+0x22>
}
    80005c44:	8082                	ret
{
    ...
    80005c52:	baa50513          	addi	a0,a0,-1110 # 800097f8 <syscalls+0x420>
    80005c56:	00001097          	auipc	ra,0x1
    80005c5a:	fa2080e7          	jalr	-94(ra) # 80006bf8 <panic>

0000000080005c5e <mbuftrim>:
{
    80005c5e:	1141                	addi	sp,sp,-16
    80005c60:	e422                	sd	s0,8(sp)
    80005c62:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c64:	491c                	lw	a5,16(a0)
    80005c66:	00b7eb63          	bltu	a5,a1,80005c7c <mbuftrim+0x1e>
  m->len -= len;
    80005c6a:	9f8d                	subw	a5,a5,a1
    80005c6c:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c6e:	1782                	slli	a5,a5,0x20
    80005c70:	9381                	srli	a5,a5,0x20
    80005c72:	6508                	ld	a0,8(a0)
    ...
    80005c7e:	bfe5                	j	80005c76 <mbuftrim+0x18>

0000000080005c80 <mbufalloc>:
{
    80005c80:	1101                	addi	sp,sp,-32
    80005c82:	ec06                	sd	ra,24(sp)
    80005c84:	e822                	sd	s0,16(sp)
    80005c86:	e426                	sd	s1,8(sp)
    80005c88:	e04a                	sd	s2,0(sp)
    80005c8a:	1000                	addi	s0,sp,32
  if (headroom > MBUF_SIZE)
    80005c8c:	6785                	lui	a5,0x1
    80005c8e:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005c92:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005c94:	02a7eb63          	bltu	a5,a0,80005cca <mbufalloc+0x4a>
    80005c98:	84aa                	mv	s1,a0
  m = kalloc();
    80005c9a:	ffffa097          	auipc	ra,0xffffa
    80005c9e:	47e080e7          	jalr	1150(ra) # 80000118 <kalloc>
    80005ca2:	892a                	mv	s2,a0
  if (m == 0)
    80005ca4:	c11d                	beqz	a0,80005cca <mbufalloc+0x4a>
  m->next = 0;
    80005ca6:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005caa:	0551                	addi	a0,a0,20
    80005cac:	1482                	slli	s1,s1,0x20
    80005cae:	9081                	srli	s1,s1,0x20
    80005cb0:	94aa                	add	s1,s1,a0
    80005cb2:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005cb6:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005cba:	6605                	lui	a2,0x1
    80005cbc:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005cc0:	4581                	li	a1,0
    80005cc2:	ffffa097          	auipc	ra,0xffffa
    80005cc6:	4b6080e7          	jalr	1206(ra) # 80000178 <memset>
}
    80005cca:	854a                	mv	a0,s2
    80005ccc:	60e2                	ld	ra,24(sp)
    80005cce:	6442                	ld	s0,16(sp)
    80005cd0:	64a2                	ld	s1,8(sp)
    80005cd2:	6902                	ld	s2,0(sp)
    80005cd4:	6105                	addi	sp,sp,32
    80005cd6:	8082                	ret

0000000080005cd8 <mbuffree>:
{
  ...
  kfree(m);
    80005ce0:	ffffa097          	auipc	ra,0xffffa
    80005ce4:	33c080e7          	jalr	828(ra) # 8000001c <kfree>
}
...
0000000080005cf0 <mbufq_pushtail>:
{
    80005cf0:	1141                	addi	sp,sp,-16
    80005cf2:	e422                	sd	s0,8(sp)
    80005cf4:	0800                	addi	s0,sp,16
  m->next = 0;
    80005cf6:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005cfa:	611c                	ld	a5,0(a0)
    80005cfc:	c799                	beqz	a5,80005d0a <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005cfe:	651c                	ld	a5,8(a0)
    80005d00:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005d02:	e50c                	sd	a1,8(a0)
}
    80005d04:	6422                	ld	s0,8(sp)
    80005d06:	0141                	addi	sp,sp,16
    80005d08:	8082                	ret
    q->head = q->tail = m;
    80005d0a:	e50c                	sd	a1,8(a0)
    80005d0c:	e10c                	sd	a1,0(a0)
    return;
    80005d0e:	bfdd                	j	80005d04 <mbufq_pushtail+0x14>

0000000080005d10 <mbufq_pophead>:
{
    80005d10:	1141                	addi	sp,sp,-16
    80005d12:	e422                	sd	s0,8(sp)
    80005d14:	0800                	addi	s0,sp,16
    80005d16:	87aa                	mv	a5,a0
  struct mbuf *head = q->head;
    80005d18:	6108                	ld	a0,0(a0)
  if (!head)
    80005d1a:	c119                	beqz	a0,80005d20 <mbufq_pophead+0x10>
  q->head = head->next;
    80005d1c:	6118                	ld	a4,0(a0)
    80005d1e:	e398                	sd	a4,0(a5)
}
    80005d20:	6422                	ld	s0,8(sp)
    80005d22:	0141                	addi	sp,sp,16
    80005d24:	8082                	ret

0000000080005d26 <mbufq_empty>:
{
    80005d26:	1141                	addi	sp,sp,-16
    80005d28:	e422                	sd	s0,8(sp)
    80005d2a:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d2c:	6108                	ld	a0,0(a0)
}
    80005d2e:	00153513          	seqz	a0,a0
    80005d32:	6422                	ld	s0,8(sp)
    80005d34:	0141                	addi	sp,sp,16
    80005d36:	8082                	ret

0000000080005d38 <mbufq_init>:
{
    80005d38:	1141                	addi	sp,sp,-16
    80005d3a:	e422                	sd	s0,8(sp)
...
{
    80005d48:	7179                	addi	sp,sp,-48
    80005d4a:	f406                	sd	ra,40(sp)
    80005d4c:	f022                	sd	s0,32(sp)
    80005d4e:	ec26                	sd	s1,24(sp)
    80005d50:	e84a                	sd	s2,16(sp)
    80005d52:	e44e                	sd	s3,8(sp)
    80005d54:	e052                	sd	s4,0(sp)
    80005d56:	1800                	addi	s0,sp,48
    80005d58:	8a2a                	mv	s4,a0
    80005d5a:	892e                	mv	s2,a1
    80005d5c:	89b2                	mv	s3,a2
    80005d5e:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d60:	45a1                	li	a1,8
    80005d62:	00000097          	auipc	ra,0x0
    80005d66:	e14080e7          	jalr	-492(ra) # 80005b76 <mbufpush>
    80005d6a:	0089d61b          	srliw	a2,s3,0x8
    80005d6e:	0089999b          	slliw	s3,s3,0x8
    80005d72:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d76:	01351023          	sh	s3,0(a0)
    80005d7a:	0084d69b          	srliw	a3,s1,0x8
    80005d7e:	0084949b          	slliw	s1,s1,0x8
    80005d82:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005d84:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005d88:	010a2783          	lw	a5,16(s4) # 3010 <_entry-0x7fffcff0>
    80005d8c:	0087d713          	srli	a4,a5,0x8
    80005d90:	0087979b          	slliw	a5,a5,0x8
    80005d94:	0ff77713          	andi	a4,a4,255
    80005d98:	8fd9                	or	a5,a5,a4
    80005d9a:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005d9e:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005da2:	45d1                	li	a1,20
    80005da4:	8552                	mv	a0,s4
    80005da6:	00000097          	auipc	ra,0x0
    80005daa:	dd0080e7          	jalr	-560(ra) # 80005b76 <mbufpush>
    80005dae:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005db0:	4651                	li	a2,20
    80005db2:	4581                	li	a1,0
    80005db4:	ffffa097          	auipc	ra,0xffffa
    80005db8:	3c4080e7          	jalr	964(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005dbc:	04500793          	li	a5,69
    80005dc0:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005dc4:	47c5                	li	a5,17
    80005dc6:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005dca:	0f0207b7          	lui	a5,0xf020
    80005dce:	27a9                	addiw	a5,a5,10
    80005dd0:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005dd2:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005dd6:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005dda:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005ddc:	0089171b          	slliw	a4,s2,0x8
    80005de0:	00ff06b7          	lui	a3,0xff0
    80005de4:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005de6:	8fd9                	or	a5,a5,a4
    80005de8:	0089591b          	srliw	s2,s2,0x8
    80005dec:	65c1                	lui	a1,0x10
    80005dee:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005df2:	00b97933          	and	s2,s2,a1
    80005df6:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005dfa:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005dfe:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005e02:	0087d713          	srli	a4,a5,0x8
    80005e06:	0087979b          	slliw	a5,a5,0x8
    80005e0a:	0ff77713          	andi	a4,a4,255
  ...
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    ...
    80005e24:	cbc080e7          	jalr	-836(ra) # 80005adc <in_cksum>
  ...
  net_tx_eth(m, ETHTYPE_IP);
    ...
    80005e38:	d78080e7          	jalr	-648(ra) # 80005bac <net_tx_eth>
...
void net_rx(struct mbuf *m)
{
  ...
  ethhdr = mbufpullhdr(m, *ethhdr);
    ...
    80005e66:	cee080e7          	jalr	-786(ra) # 80005b50 <mbufpull>
  if (!ethhdr) {
  ...
  type = ntohs(ethhdr->type);
    80005e6c:	00c54783          	lbu	a5,12(a0)
    80005e70:	00d54703          	lbu	a4,13(a0)
    80005e74:	0722                	slli	a4,a4,0x8
    80005e76:	8fd9                	or	a5,a5,a4
    80005e78:	0087979b          	slliw	a5,a5,0x8
    80005e7c:	8321                	srli	a4,a4,0x8
  ...
  if (type == ETHTYPE_IP)
    ...
    80005e92:	18e78e63          	beq	a5,a4,8000602e <net_rx+0x1e2>
  kfree(m);
  ...
  iphdr = mbufpullhdr(m, *iphdr);
    ...
    80005ec6:	c8e080e7          	jalr	-882(ra) # 80005b50 <mbufpull>
    80005eca:	892a                	mv	s2,a0
  if (!iphdr)
    80005ecc:	c519                	beqz	a0,80005eda <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005ece:	00054703          	lbu	a4,0(a0)
    80005ed2:	04500793          	li	a5,69
    80005ed6:	00f70863          	beq	a4,a5,80005ee6 <net_rx+0x9a>
  kfree(m);
    80005eda:	8526                	mv	a0,s1
    80005edc:	ffffa097          	auipc	ra,0xffffa
    80005ee0:	140080e7          	jalr	320(ra) # 8000001c <kfree>
}
    80005ee4:	bf75                	j	80005ea0 <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005ee6:	45d1                	li	a1,20
    80005ee8:	00000097          	auipc	ra,0x0
    80005eec:	bf4080e7          	jalr	-1036(ra) # 80005adc <in_cksum>
    80005ef0:	f56d                	bnez	a0,80005eda <net_rx+0x8e>
    80005ef2:	00695783          	lhu	a5,6(s2)
    80005ef6:	0087d713          	srli	a4,a5,0x8
    80005efa:	0087979b          	slliw	a5,a5,0x8
    80005efe:	0ff77713          	andi	a4,a4,255
    80005f02:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005f04:	17c2                	slli	a5,a5,0x30
    80005f06:	93c1                	srli	a5,a5,0x30
    80005f08:	fbe9                	bnez	a5,80005eda <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005f0a:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005f0e:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005f12:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005f16:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005f18:	0087169b          	slliw	a3,a4,0x8
    80005f1c:	00ff0637          	lui	a2,0xff0
    80005f20:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005f22:	8fd5                	or	a5,a5,a3
    80005f24:	0087571b          	srliw	a4,a4,0x8
    80005f28:	66c1                	lui	a3,0x10
    80005f2a:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f2e:	8f75                	and	a4,a4,a3
    80005f30:	8fd9                	or	a5,a5,a4
    80005f32:	2781                	sext.w	a5,a5
    80005f34:	0a000737          	lui	a4,0xa000
    80005f38:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f3c:	f8e79fe3          	bne	a5,a4,80005eda <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f40:	00994703          	lbu	a4,9(s2)
    80005f44:	47c5                	li	a5,17
    80005f46:	f8f71ae3          	bne	a4,a5,80005eda <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f4a:	00295783          	lhu	a5,2(s2)
    80005f4e:	0087d713          	srli	a4,a5,0x8
    80005f52:	0087999b          	slliw	s3,a5,0x8
    80005f56:	0ff77793          	andi	a5,a4,255
    80005f5a:	00f9e9b3          	or	s3,s3,a5
    80005f5e:	19c2                	slli	s3,s3,0x30
    80005f60:	0309d993          	srli	s3,s3,0x30
  len = ntohs(iphdr->ip_len) - sizeof(*iphdr);
    80005f64:	fec9879b          	addiw	a5,s3,-20
    80005f68:	03079a13          	slli	s4,a5,0x30
    80005f6c:	030a5a13          	srli	s4,s4,0x30
  udphdr = mbufpullhdr(m, *udphdr);
    80005f70:	45a1                	li	a1,8
    80005f72:	8526                	mv	a0,s1
    80005f74:	00000097          	auipc	ra,0x0
    80005f78:	bdc080e7          	jalr	-1060(ra) # 80005b50 <mbufpull>
    80005f7c:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f7e:	c915                	beqz	a0,80005fb2 <net_rx+0x166>
    80005f80:	00455783          	lhu	a5,4(a0)
    80005f84:	0087d713          	srli	a4,a5,0x8
    80005f88:	0087979b          	slliw	a5,a5,0x8
    80005f8c:	0ff77713          	andi	a4,a4,255
    80005f90:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005f92:	2a01                	sext.w	s4,s4
    80005f94:	17c2                	slli	a5,a5,0x30
    80005f96:	93c1                	srli	a5,a5,0x30
    80005f98:	00fa1d63          	bne	s4,a5,80005fb2 <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005f9c:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005fa0:	0107979b          	slliw	a5,a5,0x10
    80005fa4:	0107d79b          	srliw	a5,a5,0x10
    80005fa8:	0007871b          	sext.w	a4,a5
    80005fac:	488c                	lw	a1,16(s1)
    80005fae:	00e5f863          	bgeu	a1,a4,80005fbe <net_rx+0x172>
  kfree(m);
    80005fb2:	8526                	mv	a0,s1
    80005fb4:	ffffa097          	auipc	ra,0xffffa
    80005fb8:	068080e7          	jalr	104(ra) # 8000001c <kfree>
}
    80005fbc:	b5d5                	j	80005ea0 <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005fbe:	9d9d                	subw	a1,a1,a5
    80005fc0:	8526                	mv	a0,s1
    80005fc2:	00000097          	auipc	ra,0x0
    80005fc6:	c9c080e7          	jalr	-868(ra) # 80005c5e <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005fca:	00c92783          	lw	a5,12(s2)
    80005fce:	000ad703          	lhu	a4,0(s5)
    80005fd2:	00875693          	srli	a3,a4,0x8
    80005fd6:	0087171b          	slliw	a4,a4,0x8
    80005fda:	0ff6f693          	andi	a3,a3,255
    80005fde:	8ed9                	or	a3,a3,a4
    80005fe0:	002ad703          	lhu	a4,2(s5)
    80005fe4:	00875613          	srli	a2,a4,0x8
    80005fe8:	0087171b          	slliw	a4,a4,0x8
    80005fec:	0ff67613          	andi	a2,a2,255
    80005ff0:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80005ff2:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80005ff6:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005ffa:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80005ffc:	0087959b          	slliw	a1,a5,0x8
    80006000:	00ff0537          	lui	a0,0xff0
    80006004:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80006006:	8f4d                	or	a4,a4,a1
    80006008:	0087d79b          	srliw	a5,a5,0x8
    8000600c:	65c1                	lui	a1,0x10
    8000600e:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80006012:	8fed                	and	a5,a5,a1
    80006014:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    80006016:	16c2                	slli	a3,a3,0x30
    80006018:	92c1                	srli	a3,a3,0x30
    8000601a:	1642                	slli	a2,a2,0x30
    8000601c:	9241                	srli	a2,a2,0x30
    8000601e:	0007859b          	sext.w	a1,a5
    80006022:	8526                	mv	a0,s1
    80006024:	00000097          	auipc	ra,0x0
    80006028:	55c080e7          	jalr	1372(ra) # 80006580 <sockrecvudp>
  return;
    8000602c:	bd95                	j	80005ea0 <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    8000602e:	45f1                	li	a1,28
    80006030:	8526                	mv	a0,s1
    80006032:	00000097          	auipc	ra,0x0
    80006036:	b1e080e7          	jalr	-1250(ra) # 80005b50 <mbufpull>
    8000603a:	892a                	mv	s2,a0
  if (!arphdr)
    8000603c:	c179                	beqz	a0,80006102 <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    8000603e:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006042:	00154703          	lbu	a4,1(a0)
    80006046:	0722                	slli	a4,a4,0x8
    80006048:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    8000604a:	0087979b          	slliw	a5,a5,0x8
    8000604e:	8321                	srli	a4,a4,0x8
    80006050:	8fd9                	or	a5,a5,a4
    80006052:	17c2                	slli	a5,a5,0x30
    80006054:	93c1                	srli	a5,a5,0x30
    80006056:	4705                	li	a4,1
    80006058:	0ae79563          	bne	a5,a4,80006102 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    8000605c:	00254783          	lbu	a5,2(a0)
    80006060:	00354703          	lbu	a4,3(a0)
    80006064:	0722                	slli	a4,a4,0x8
    80006066:	8fd9                	or	a5,a5,a4
    80006068:	0087979b          	slliw	a5,a5,0x8
    8000606c:	8321                	srli	a4,a4,0x8
    8000606e:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006070:	0107979b          	slliw	a5,a5,0x10
    80006074:	0107d79b          	srliw	a5,a5,0x10
    80006078:	8007879b          	addiw	a5,a5,-2048
    8000607c:	e3d9                	bnez	a5,80006102 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    8000607e:	00454703          	lbu	a4,4(a0)
    80006082:	4799                	li	a5,6
    80006084:	06f71f63          	bne	a4,a5,80006102 <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    80006088:	00554703          	lbu	a4,5(a0)
    8000608c:	4791                	li	a5,4
    8000608e:	06f71a63          	bne	a4,a5,80006102 <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006092:	00654783          	lbu	a5,6(a0)
    80006096:	00754703          	lbu	a4,7(a0)
    8000609a:	0722                	slli	a4,a4,0x8
    8000609c:	8fd9                	or	a5,a5,a4
    8000609e:	0087979b          	slliw	a5,a5,0x8
    800060a2:	8321                	srli	a4,a4,0x8
    800060a4:	8fd9                	or	a5,a5,a4
    800060a6:	17c2                	slli	a5,a5,0x30
    800060a8:	93c1                	srli	a5,a5,0x30
    800060aa:	4705                	li	a4,1
    800060ac:	04e79b63          	bne	a5,a4,80006102 <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    800060b0:	01854783          	lbu	a5,24(a0)
    800060b4:	01954703          	lbu	a4,25(a0)
    800060b8:	0722                	slli	a4,a4,0x8
    800060ba:	8f5d                	or	a4,a4,a5
    800060bc:	01a54783          	lbu	a5,26(a0)
    800060c0:	07c2                	slli	a5,a5,0x10
    800060c2:	8f5d                	or	a4,a4,a5
    800060c4:	01b54783          	lbu	a5,27(a0)
    800060c8:	07e2                	slli	a5,a5,0x18
    800060ca:	8fd9                	or	a5,a5,a4
    800060cc:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060d0:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    800060d4:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800060d8:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    800060da:	0087169b          	slliw	a3,a4,0x8
    800060de:	00ff0637          	lui	a2,0xff0
    800060e2:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    800060e4:	8fd5                	or	a5,a5,a3
    800060e6:	0087571b          	srliw	a4,a4,0x8
    800060ea:	66c1                	lui	a3,0x10
    800060ec:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    800060f0:	8f75                	and	a4,a4,a3
    800060f2:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060f4:	2781                	sext.w	a5,a5
    800060f6:	0a000737          	lui	a4,0xa000
    800060fa:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    800060fe:	00e78863          	beq	a5,a4,8000610e <net_rx+0x2c2>
  kfree(m);
    80006102:	8526                	mv	a0,s1
    80006104:	ffffa097          	auipc	ra,0xffffa
    80006108:	f18080e7          	jalr	-232(ra) # 8000001c <kfree>
}
    8000610c:	bb51                	j	80005ea0 <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    8000610e:	4619                	li	a2,6
    80006110:	00850593          	addi	a1,a0,8
    80006114:	fb840513          	addi	a0,s0,-72
    80006118:	ffffa097          	auipc	ra,0xffffa
    8000611c:	0c0080e7          	jalr	192(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    80006120:	00e94783          	lbu	a5,14(s2)
    80006124:	00f94703          	lbu	a4,15(s2)
    80006128:	0722                	slli	a4,a4,0x8
    8000612a:	8f5d                	or	a4,a4,a5
    8000612c:	01094783          	lbu	a5,16(s2)
    80006130:	07c2                	slli	a5,a5,0x10
    80006132:	8f5d                	or	a4,a4,a5
    80006134:	01194783          	lbu	a5,17(s2)
    80006138:	07e2                	slli	a5,a5,0x18
    8000613a:	8fd9                	or	a5,a5,a4
    8000613c:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006140:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006144:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80006148:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    8000614c:	0087179b          	slliw	a5,a4,0x8
    80006150:	00ff06b7          	lui	a3,0xff0
    80006154:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006156:	00f96933          	or	s2,s2,a5
    8000615a:	0087579b          	srliw	a5,a4,0x8
    8000615e:	6741                	lui	a4,0x10
    80006160:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006164:	8ff9                	and	a5,a5,a4
    80006166:	00f96933          	or	s2,s2,a5
    8000616a:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    8000616c:	08000513          	li	a0,128
    80006170:	00000097          	auipc	ra,0x0
    80006174:	b10080e7          	jalr	-1264(ra) # 80005c80 <mbufalloc>
    80006178:	8a2a                	mv	s4,a0
  if (!m)
    8000617a:	d541                	beqz	a0,80006102 <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    8000617c:	45f1                	li	a1,28
    8000617e:	00000097          	auipc	ra,0x0
    80006182:	aa6080e7          	jalr	-1370(ra) # 80005c24 <mbufput>
    80006186:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    80006188:	00050023          	sb	zero,0(a0)
    8000618c:	4785                	li	a5,1
    8000618e:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    80006192:	47a1                	li	a5,8
    80006194:	00f50123          	sb	a5,2(a0)
    80006198:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    8000619c:	4799                	li	a5,6
    8000619e:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    800061a2:	4791                	li	a5,4
    800061a4:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    800061a8:	00050323          	sb	zero,6(a0)
    800061ac:	4a89                	li	s5,2
    800061ae:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    800061b2:	4619                	li	a2,6
    800061b4:	00003597          	auipc	a1,0x3
    800061b8:	6ec58593          	addi	a1,a1,1772 # 800098a0 <local_mac>
    800061bc:	0521                	addi	a0,a0,8
    800061be:	ffffa097          	auipc	ra,0xffffa
    800061c2:	01a080e7          	jalr	26(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    800061c6:	47a9                	li	a5,10
    800061c8:	00f98723          	sb	a5,14(s3)
    800061cc:	000987a3          	sb	zero,15(s3)
    800061d0:	01598823          	sb	s5,16(s3)
    800061d4:	47bd                	li	a5,15
    800061d6:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    800061da:	4619                	li	a2,6
    800061dc:	fb840593          	addi	a1,s0,-72
    800061e0:	01298513          	addi	a0,s3,18
    800061e4:	ffffa097          	auipc	ra,0xffffa
    800061e8:	ff4080e7          	jalr	-12(ra) # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    800061ec:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    800061f0:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800061f4:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    800061f6:	0089179b          	slliw	a5,s2,0x8
    800061fa:	00ff06b7          	lui	a3,0xff0
    800061fe:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    80006200:	8f5d                	or	a4,a4,a5
    80006202:	0089579b          	srliw	a5,s2,0x8
    80006206:	66c1                	lui	a3,0x10
    80006208:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    8000620c:	8ff5                	and	a5,a5,a3
    8000620e:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    80006210:	00e98c23          	sb	a4,24(s3)
    80006214:	0087d71b          	srliw	a4,a5,0x8
    80006218:	00e98ca3          	sb	a4,25(s3)
    8000621c:	0107d71b          	srliw	a4,a5,0x10
    80006220:	00e98d23          	sb	a4,26(s3)
    80006224:	0187d79b          	srliw	a5,a5,0x18
    80006228:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    8000622c:	6585                	lui	a1,0x1
    8000622e:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    80006232:	8552                	mv	a0,s4
    80006234:	00000097          	auipc	ra,0x0
    80006238:	978080e7          	jalr	-1672(ra) # 80005bac <net_tx_eth>
  return 0;
    8000623c:	b5d9                	j	80006102 <net_rx+0x2b6>

000000008000623e <sockinit>:
...
sockinit(void)
{
    8000623e:	1141                	addi	sp,sp,-16
    80006240:	e406                	sd	ra,8(sp)
    80006242:	e022                	sd	s0,0(sp)
    80006244:	0800                	addi	s0,sp,16
  initlock(&lock, "socktbl");
    80006246:	00003597          	auipc	a1,0x3
    8000624a:	5ba58593          	addi	a1,a1,1466 # 80009800 <syscalls+0x428>
    8000624e:	00019517          	auipc	a0,0x19
    80006252:	0d250513          	addi	a0,a0,210 # 8001f320 <lock>
    80006256:	00001097          	auipc	ra,0x1
    8000625a:	e5c080e7          	jalr	-420(ra) # 800070b2 <initlock>
}
...
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    80006276:	0080                	addi	s0,sp,64
    80006278:	892a                	mv	s2,a0
    8000627a:	84ae                	mv	s1,a1
    8000627c:	8a32                	mv	s4,a2
    8000627e:	89b6                	mv	s3,a3
  struct sock *si, *pos;

  si = 0;
  *f = 0;
    80006280:	00053023          	sd	zero,0(a0)
  if ((*f = filealloc()) == 0)
    80006284:	ffffd097          	auipc	ra,0xffffd
    80006288:	64c080e7          	jalr	1612(ra) # 800038d0 <filealloc>
    8000628c:	00a93023          	sd	a0,0(s2)
    80006290:	c975                	beqz	a0,80006384 <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    80006292:	ffffa097          	auipc	ra,0xffffa
    80006296:	e86080e7          	jalr	-378(ra) # 80000118 <kalloc>
    8000629a:	8aaa                	mv	s5,a0
    8000629c:	c15d                	beqz	a0,80006342 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    8000629e:	c504                	sw	s1,8(a0)
  si->lport = lport;
    800062a0:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    800062a4:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    800062a8:	00003597          	auipc	a1,0x3
    800062ac:	56058593          	addi	a1,a1,1376 # 80009808 <syscalls+0x430>
    800062b0:	0541                	addi	a0,a0,16
    800062b2:	00001097          	auipc	ra,0x1
    800062b6:	e00080e7          	jalr	-512(ra) # 800070b2 <initlock>
  mbufq_init(&si->rxq);
    800062ba:	028a8513          	addi	a0,s5,40
    800062be:	00000097          	auipc	ra,0x0
    800062c2:	a7a080e7          	jalr	-1414(ra) # 80005d38 <mbufq_init>
  (*f)->type = FD_SOCK;
    800062c6:	00093783          	ld	a5,0(s2)
    800062ca:	4711                	li	a4,4
    800062cc:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062ce:	00093703          	ld	a4,0(s2)
    800062d2:	4785                	li	a5,1
    800062d4:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    800062d8:	00093703          	ld	a4,0(s2)
    800062dc:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    800062e0:	00093783          	ld	a5,0(s2)
    800062e4:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>

  // add to list of sockets
  acquire(&lock);
    800062e8:	00019517          	auipc	a0,0x19
    800062ec:	03850513          	addi	a0,a0,56 # 8001f320 <lock>
    800062f0:	00001097          	auipc	ra,0x1
    800062f4:	e52080e7          	jalr	-430(ra) # 80007142 <acquire>
  pos = sockets;
    800062f8:	00004597          	auipc	a1,0x4
    800062fc:	d305b583          	ld	a1,-720(a1) # 8000a028 <sockets>
  while (pos) {
    80006300:	c9b1                	beqz	a1,80006354 <sockalloc+0xee>
  pos = sockets;
    80006302:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    80006304:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    80006308:	0009869b          	sext.w	a3,s3
    8000630c:	a019                	j	80006312 <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
    pos = pos->next;
    8000630e:	639c                	ld	a5,0(a5)
  while (pos) {
    80006310:	c3b1                	beqz	a5,80006354 <sockalloc+0xee>
    if (pos->raddr == raddr &&
    80006312:	4798                	lw	a4,8(a5)
    80006314:	fe971de3          	bne	a4,s1,8000630e <sockalloc+0xa8>
    80006318:	00c7d703          	lhu	a4,12(a5)
    8000631c:	fec719e3          	bne	a4,a2,8000630e <sockalloc+0xa8>
        pos->lport == lport &&
    80006320:	00e7d703          	lhu	a4,14(a5)
    80006324:	fed715e3          	bne	a4,a3,8000630e <sockalloc+0xa8>
      release(&lock);
    80006328:	00019517          	auipc	a0,0x19
    8000632c:	ff850513          	addi	a0,a0,-8 # 8001f320 <lock>
    80006330:	00001097          	auipc	ra,0x1
    80006334:	ec6080e7          	jalr	-314(ra) # 800071f6 <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    ...
    8000633e:	ce2080e7          	jalr	-798(ra) # 8000001c <kfree>
  if (*f)
    80006342:	00093503          	ld	a0,0(s2)
    80006346:	c129                	beqz	a0,80006388 <sockalloc+0x122>
    fileclose(*f);
    80006348:	ffffd097          	auipc	ra,0xffffd
    8000634c:	644080e7          	jalr	1604(ra) # 8000398c <fileclose>
  return -1;
    80006350:	557d                	li	a0,-1
    80006352:	a005                	j	80006372 <sockalloc+0x10c>
  si->next = sockets;
    80006354:	00bab023          	sd	a1,0(s5)
  sockets = si;
    80006358:	00004797          	auipc	a5,0x4
    8000635c:	cd57b823          	sd	s5,-816(a5) # 8000a028 <sockets>
  release(&lock);
    80006360:	00019517          	auipc	a0,0x19
    80006364:	fc050513          	addi	a0,a0,-64 # 8001f320 <lock>
    80006368:	00001097          	auipc	ra,0x1
    8000636c:	e8e080e7          	jalr	-370(ra) # 800071f6 <release>
  return 0;
    80006370:	4501                	li	a0,0
}
    80006372:	70e2                	ld	ra,56(sp)
    80006374:	7442                	ld	s0,48(sp)
    80006376:	74a2                	ld	s1,40(sp)
    80006378:	7902                	ld	s2,32(sp)
    8000637a:	69e2                	ld	s3,24(sp)
    8000637c:	6a42                	ld	s4,16(sp)
    8000637e:	6aa2                	ld	s5,8(sp)
    80006380:	6121                	addi	sp,sp,64
    80006382:	8082                	ret
  return -1;
    80006384:	557d                	li	a0,-1
    80006386:	b7f5                	j	80006372 <sockalloc+0x10c>
    80006388:	557d                	li	a0,-1
    8000638a:	b7e5                	j	80006372 <sockalloc+0x10c>

000000008000638c <sockclose>:
...
sockclose(struct sock *si)
{
  ...
  acquire(&lock);
    ...
    800063a6:	da0080e7          	jalr	-608(ra) # 80007142 <acquire>
  pos = &sockets;
    800063aa:	00004797          	auipc	a5,0x4
    800063ae:	c7e7b783          	ld	a5,-898(a5) # 8000a028 <sockets>
  while (*pos) {
    800063b2:	cb99                	beqz	a5,800063c8 <sockclose+0x3c>
    if (*pos == si){
    800063b4:	02f90563          	beq	s2,a5,800063de <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    800063b8:	873e                	mv	a4,a5
    800063ba:	639c                	ld	a5,0(a5)
  while (*pos) {
    800063bc:	c791                	beqz	a5,800063c8 <sockclose+0x3c>
    if (*pos == si){
    800063be:	fef91de3          	bne	s2,a5,800063b8 <sockclose+0x2c>
      *pos = si->next;
    800063c2:	00093783          	ld	a5,0(s2)
    800063c6:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    800063c8:	00019517          	auipc	a0,0x19
    800063cc:	f5850513          	addi	a0,a0,-168 # 8001f320 <lock>
    800063d0:	00001097          	auipc	ra,0x1
    800063d4:	e26080e7          	jalr	-474(ra) # 800071f6 <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    800063d8:	02890493          	addi	s1,s2,40
    800063dc:	a839                	j	800063fa <sockclose+0x6e>
  pos = &sockets;
    800063de:	00004717          	auipc	a4,0x4
    800063e2:	c4a70713          	addi	a4,a4,-950 # 8000a028 <sockets>
    800063e6:	bff1                	j	800063c2 <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    800063e8:	8526                	mv	a0,s1
    800063ea:	00000097          	auipc	ra,0x0
    800063ee:	926080e7          	jalr	-1754(ra) # 80005d10 <mbufq_pophead>
    mbuffree(m);
    800063f2:	00000097          	auipc	ra,0x0
    800063f6:	8e6080e7          	jalr	-1818(ra) # 80005cd8 <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    800063fa:	8526                	mv	a0,s1
    800063fc:	00000097          	auipc	ra,0x0
    80006400:	92a080e7          	jalr	-1750(ra) # 80005d26 <mbufq_empty>
    80006404:	d175                	beqz	a0,800063e8 <sockclose+0x5c>
  }

  kfree((char*)si);
    80006406:	854a                	mv	a0,s2
    80006408:	ffffa097          	auipc	ra,0xffffa
    8000640c:	c14080e7          	jalr	-1004(ra) # 8000001c <kfree>
}
    80006410:	60e2                	ld	ra,24(sp)
    80006412:	6442                	ld	s0,16(sp)
    80006414:	64a2                	ld	s1,8(sp)
    80006416:	6902                	ld	s2,0(sp)
    80006418:	6105                	addi	sp,sp,32
    8000641a:	8082                	ret

000000008000641c <sockread>:

int
sockread(struct sock *si, uint64 addr, int n)
{
    8000641c:	7139                	addi	sp,sp,-64
    8000641e:	fc06                	sd	ra,56(sp)
    80006420:	f822                	sd	s0,48(sp)
    80006422:	f426                	sd	s1,40(sp)
    80006424:	f04a                	sd	s2,32(sp)
    80006426:	ec4e                	sd	s3,24(sp)
    80006428:	e852                	sd	s4,16(sp)
    8000642a:	e456                	sd	s5,8(sp)
    8000642c:	0080                	addi	s0,sp,64
    8000642e:	84aa                	mv	s1,a0
    80006430:	8a2e                	mv	s4,a1
    80006432:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    80006434:	ffffb097          	auipc	ra,0xffffb
    80006438:	a6c080e7          	jalr	-1428(ra) # 80000ea0 <myproc>
    8000643c:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    8000643e:	01048993          	addi	s3,s1,16
    80006442:	854e                	mv	a0,s3
    80006444:	00001097          	auipc	ra,0x1
    80006448:	cfe080e7          	jalr	-770(ra) # 80007142 <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    8000644c:	02848493          	addi	s1,s1,40
    80006450:	8526                	mv	a0,s1
    80006452:	00000097          	auipc	ra,0x0
    80006456:	8d4080e7          	jalr	-1836(ra) # 80005d26 <mbufq_empty>
    8000645a:	c919                	beqz	a0,80006470 <sockread+0x54>
    8000645c:	02892783          	lw	a5,40(s2)
    80006460:	eba5                	bnez	a5,800064d0 <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    80006462:	85ce                	mv	a1,s3
    80006464:	8526                	mv	a0,s1
    80006466:	ffffb097          	auipc	ra,0xffffb
    8000646a:	0f6080e7          	jalr	246(ra) # 8000155c <sleep>
    8000646e:	b7cd                	j	80006450 <sockread+0x34>
  }
  if (pr->killed) {
    80006470:	02892783          	lw	a5,40(s2)
    80006474:	efb1                	bnez	a5,800064d0 <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    8000647c:	898080e7          	jalr	-1896(ra) # 80005d10 <mbufq_pophead>
    80006480:	84aa                	mv	s1,a0
  release(&si->lock);
    80006482:	854e                	mv	a0,s3
    80006484:	00001097          	auipc	ra,0x1
    80006488:	d72080e7          	jalr	-654(ra) # 800071f6 <release>

  len = m->len;
    8000648c:	489c                	lw	a5,16(s1)
  if (len > n)
    8000648e:	89be                	mv	s3,a5
    80006490:	00fad363          	bge	s5,a5,80006496 <sockread+0x7a>
    80006494:	89d6                	mv	s3,s5
    80006496:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    80006498:	86ce                	mv	a3,s3
    8000649a:	6490                	ld	a2,8(s1)
    8000649c:	85d2                	mv	a1,s4
    8000649e:	05093503          	ld	a0,80(s2)
    800064a2:	ffffa097          	auipc	ra,0xffffa
    800064a6:	6c4080e7          	jalr	1732(ra) # 80000b66 <copyout>
    800064aa:	892a                	mv	s2,a0
    800064ac:	57fd                	li	a5,-1
    800064ae:	02f50863          	beq	a0,a5,800064de <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    800064b8:	824080e7          	jalr	-2012(ra) # 80005cd8 <mbuffree>
  return len;
}
    800064bc:	854e                	mv	a0,s3
    800064be:	70e2                	ld	ra,56(sp)
    800064c0:	7442                	ld	s0,48(sp)
    800064c2:	74a2                	ld	s1,40(sp)
    800064c4:	7902                	ld	s2,32(sp)
    800064c6:	69e2                	ld	s3,24(sp)
    800064c8:	6a42                	ld	s4,16(sp)
    800064ca:	6aa2                	ld	s5,8(sp)
    800064cc:	6121                	addi	sp,sp,64
    800064ce:	8082                	ret
    release(&si->lock);
    800064d0:	854e                	mv	a0,s3
    800064d2:	00001097          	auipc	ra,0x1
    800064d6:	d24080e7          	jalr	-732(ra) # 800071f6 <release>
    return -1;
    800064da:	59fd                	li	s3,-1
    800064dc:	b7c5                	j	800064bc <sockread+0xa0>
    mbuffree(m);
    800064de:	8526                	mv	a0,s1
    800064e0:	fffff097          	auipc	ra,0xfffff
    800064e4:	7f8080e7          	jalr	2040(ra) # 80005cd8 <mbuffree>
    return -1;
    800064e8:	89ca                	mv	s3,s2
    800064ea:	bfc9                	j	800064bc <sockread+0xa0>

00000000800064ec <sockwrite>:
...
sockwrite(struct sock *si, uint64 addr, int n)
{
    ...
    800064fe:	8aaa                	mv	s5,a0
    80006500:	89ae                	mv	s3,a1
    80006502:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    80006504:	ffffb097          	auipc	ra,0xffffb
    80006508:	99c080e7          	jalr	-1636(ra) # 80000ea0 <myproc>
    8000650c:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    8000650e:	08000513          	li	a0,128
    80006512:	fffff097          	auipc	ra,0xfffff
    80006516:	76e080e7          	jalr	1902(ra) # 80005c80 <mbufalloc>
  if (!m)
    8000651a:	c12d                	beqz	a0,8000657c <sockwrite+0x90>
    8000651c:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    8000651e:	050a3a03          	ld	s4,80(s4)
    80006522:	85ca                	mv	a1,s2
    80006524:	fffff097          	auipc	ra,0xfffff
    80006528:	700080e7          	jalr	1792(ra) # 80005c24 <mbufput>
    8000652c:	85aa                	mv	a1,a0
    8000652e:	86ca                	mv	a3,s2
    80006530:	864e                	mv	a2,s3
    80006532:	8552                	mv	a0,s4
    80006534:	ffffa097          	auipc	ra,0xffffa
    80006538:	6be080e7          	jalr	1726(ra) # 80000bf2 <copyin>
    8000653c:	89aa                	mv	s3,a0
    8000653e:	57fd                	li	a5,-1
    80006540:	02f50863          	beq	a0,a5,80006570 <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    80006544:	00ead683          	lhu	a3,14(s5)
    80006548:	00cad603          	lhu	a2,12(s5)
    8000654c:	008aa583          	lw	a1,8(s5)
    80006550:	8526                	mv	a0,s1
    80006552:	fffff097          	auipc	ra,0xfffff
    80006556:	7f6080e7          	jalr	2038(ra) # 80005d48 <net_tx_udp>
  return n;
    8000655a:	89ca                	mv	s3,s2
}
    8000655c:	854e                	mv	a0,s3
    8000655e:	70e2                	ld	ra,56(sp)
    80006560:	7442                	ld	s0,48(sp)
    80006562:	74a2                	ld	s1,40(sp)
    80006564:	7902                	ld	s2,32(sp)
    80006566:	69e2                	ld	s3,24(sp)
    80006568:	6a42                	ld	s4,16(sp)
    8000656a:	6aa2                	ld	s5,8(sp)
    8000656c:	6121                	addi	sp,sp,64
    8000656e:	8082                	ret
    mbuffree(m);
    80006570:	8526                	mv	a0,s1
    80006572:	fffff097          	auipc	ra,0xfffff
    80006576:	766080e7          	jalr	1894(ra) # 80005cd8 <mbuffree>
    return -1;
    8000657a:	b7cd                	j	8000655c <sockwrite+0x70>
    return -1;
    8000657c:	59fd                	li	s3,-1
    8000657e:	bff9                	j	8000655c <sockwrite+0x70>

0000000080006580 <sockrecvudp>:
...
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    80006594:	892e                	mv	s2,a1
    80006596:	89b2                	mv	s3,a2
    80006598:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    ...
    800065a6:	ba0080e7          	jalr	-1120(ra) # 80007142 <acquire>
  si = sockets;
    800065aa:	00004497          	auipc	s1,0x4
    800065ae:	a7e4b483          	ld	s1,-1410(s1) # 8000a028 <sockets>
  while (si) {
    800065b2:	c4ad                	beqz	s1,8000661c <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065b4:	0009871b          	sext.w	a4,s3
    800065b8:	000a869b          	sext.w	a3,s5
    800065bc:	a019                	j	800065c2 <sockrecvudp+0x42>
      goto found;
    si = si->next;
    800065be:	6084                	ld	s1,0(s1)
  while (si) {
    800065c0:	ccb1                	beqz	s1,8000661c <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065c2:	449c                	lw	a5,8(s1)
    800065c4:	ff279de3          	bne	a5,s2,800065be <sockrecvudp+0x3e>
    800065c8:	00c4d783          	lhu	a5,12(s1)
    800065cc:	fee799e3          	bne	a5,a4,800065be <sockrecvudp+0x3e>
    800065d0:	00e4d783          	lhu	a5,14(s1)
    800065d4:	fed795e3          	bne	a5,a3,800065be <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    800065d8:	01048913          	addi	s2,s1,16
    800065dc:	854a                	mv	a0,s2
    800065de:	00001097          	auipc	ra,0x1
    800065e2:	b64080e7          	jalr	-1180(ra) # 80007142 <acquire>
  mbufq_pushtail(&si->rxq, m);
    800065e6:	02848493          	addi	s1,s1,40
    800065ea:	85d2                	mv	a1,s4
    800065ec:	8526                	mv	a0,s1
    800065ee:	fffff097          	auipc	ra,0xfffff
    800065f2:	702080e7          	jalr	1794(ra) # 80005cf0 <mbufq_pushtail>
  wakeup(&si->rxq);
    800065f6:	8526                	mv	a0,s1
    800065f8:	ffffb097          	auipc	ra,0xffffb
    800065fc:	0f0080e7          	jalr	240(ra) # 800016e8 <wakeup>
  release(&si->lock);
    80006600:	854a                	mv	a0,s2
    80006602:	00001097          	auipc	ra,0x1
    80006606:	bf4080e7          	jalr	-1036(ra) # 800071f6 <release>
  release(&lock);
    8000660a:	00019517          	auipc	a0,0x19
    8000660e:	d1650513          	addi	a0,a0,-746 # 8001f320 <lock>
    80006612:	00001097          	auipc	ra,0x1
    80006616:	be4080e7          	jalr	-1052(ra) # 800071f6 <release>
    8000661a:	a831                	j	80006636 <sockrecvudp+0xb6>
  release(&lock);
    8000661c:	00019517          	auipc	a0,0x19
    80006620:	d0450513          	addi	a0,a0,-764 # 8001f320 <lock>
    80006624:	00001097          	auipc	ra,0x1
    80006628:	bd2080e7          	jalr	-1070(ra) # 800071f6 <release>
  mbuffree(m);
    8000662c:	8552                	mv	a0,s4
    8000662e:	fffff097          	auipc	ra,0xfffff
    80006632:	6aa080e7          	jalr	1706(ra) # 80005cd8 <mbuffree>
}
    ...
    80006644:	6121                	addi	sp,sp,64
    80006646:	8082                	ret

0000000080006648 <pci_init>:
#include "proc.h"
#include "defs.h"
...
pci_init()
{
    80006648:	715d                	addi	sp,sp,-80
    8000664a:	e486                	sd	ra,72(sp)
    8000664c:	e0a2                	sd	s0,64(sp)
    8000664e:	fc26                	sd	s1,56(sp)
    80006650:	f84a                	sd	s2,48(sp)
    80006652:	f44e                	sd	s3,40(sp)
    80006654:	f052                	sd	s4,32(sp)
    80006656:	ec56                	sd	s5,24(sp)
    80006658:	e85a                	sd	s6,16(sp)
    8000665a:	e45e                	sd	s7,8(sp)
    8000665c:	0880                	addi	s0,sp,80
    8000665e:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    80006662:	100e8937          	lui	s2,0x100e8
    80006666:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    8000666a:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    8000666c:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    8000666e:	40000b37          	lui	s6,0x40000
    80006672:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    80006674:	300409b7          	lui	s3,0x30040
    80006678:	a821                	j	80006690 <pci_init+0x48>
      base[4+0] = e1000_regs;
    8000667a:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    8000667e:	40000537          	lui	a0,0x40000
    80006682:	fffff097          	auipc	ra,0xfffff
    80006686:	0de080e7          	jalr	222(ra) # 80005760 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    8000668a:	94d2                	add	s1,s1,s4
    8000668c:	03348a63          	beq	s1,s3,800066c0 <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    80006690:	86a6                	mv	a3,s1
    uint32 id = base[0];
    80006692:	409c                	lw	a5,0(s1)
    80006694:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    80006696:	ff279ae3          	bne	a5,s2,8000668a <pci_init+0x42>
      base[1] = 7;
    8000669a:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    8000669e:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    800066a2:	01048793          	addi	a5,s1,16
    800066a6:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    800066aa:	4398                	lw	a4,0(a5)
    800066ac:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    800066ae:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    800066b2:	0ff0000f          	fence
        base[4+i] = old;
    800066b6:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    800066b8:	0791                	addi	a5,a5,4
    800066ba:	fec798e3          	bne	a5,a2,800066aa <pci_init+0x62>
    800066be:	bf75                	j	8000667a <pci_init+0x32>
    }
  }
}
    800066c0:	60a6                	ld	ra,72(sp)
    800066c2:	6406                	ld	s0,64(sp)
    800066c4:	74e2                	ld	s1,56(sp)
    800066c6:	7942                	ld	s2,48(sp)
    800066c8:	79a2                	ld	s3,40(sp)
    800066ca:	7a02                	ld	s4,32(sp)
    800066cc:	6ae2                	ld	s5,24(sp)
    800066ce:	6b42                	ld	s6,16(sp)
    800066d0:	6ba2                	ld	s7,8(sp)
    800066d2:	6161                	addi	sp,sp,80
    800066d4:	8082                	ret

00000000800066d6 <timerinit>:
...
timerinit()
{
  ...
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800066dc:	f14027f3          	csrr	a5,mhartid
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    800066e4:	0037979b          	slliw	a5,a5,0x3
    800066e8:	02004737          	lui	a4,0x2004
    800066ec:	97ba                	add	a5,a5,a4
    800066ee:	0200c737          	lui	a4,0x200c
    800066f2:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    800066f6:	000f4637          	lui	a2,0xf4
    800066fa:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    800066fe:	95b2                	add	a1,a1,a2
    80006700:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    80006702:	00269713          	slli	a4,a3,0x2
    80006706:	9736                	add	a4,a4,a3
    80006708:	00371693          	slli	a3,a4,0x3
    8000670c:	00019717          	auipc	a4,0x19
    80006710:	c3470713          	addi	a4,a4,-972 # 8001f340 <timer_scratch>
    80006714:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    80006716:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    80006718:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    8000671a:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    8000671e:	fffff797          	auipc	a5,0xfffff
    80006722:	9e278793          	addi	a5,a5,-1566 # 80005100 <timervec>
    80006726:	30579073          	csrw	mtvec,a5
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    8000672a:	300027f3          	csrr	a5,mstatus
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    8000672e:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006732:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    80006736:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    8000673a:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    8000673e:	30479073          	csrw	mie,a5
}
    80006742:	6422                	ld	s0,8(sp)
    80006744:	0141                	addi	sp,sp,16
    80006746:	8082                	ret

0000000080006748 <start>:
{
  ...
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006750:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    80006754:	7779                	lui	a4,0xffffe
    80006756:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    8000675a:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    8000675c:	6705                	lui	a4,0x1
    8000675e:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    80006762:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006764:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    80006768:	ffffa797          	auipc	a5,0xffffa
    8000676c:	bbe78793          	addi	a5,a5,-1090 # 80000326 <main>
    80006770:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    80006774:	4781                	li	a5,0
    80006776:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    8000677a:	67c1                	lui	a5,0x10
    8000677c:	17fd                	addi	a5,a5,-1
    8000677e:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    80006782:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    80006786:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    8000678a:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    8000678e:	10479073          	csrw	sie,a5
  asm volatile("csrw pmpaddr0, %0" : : "r" (x));
    80006792:	57fd                	li	a5,-1
    80006794:	83a9                	srli	a5,a5,0xa
    80006796:	3b079073          	csrw	pmpaddr0,a5
  asm volatile("csrw pmpcfg0, %0" : : "r" (x));
    8000679a:	47bd                	li	a5,15
    8000679c:	3a079073          	csrw	pmpcfg0,a5
  timerinit();
    800067a0:	00000097          	auipc	ra,0x0
    800067a4:	f36080e7          	jalr	-202(ra) # 800066d6 <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800067a8:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    800067ac:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    800067ae:	823e                	mv	tp,a5
  asm volatile("mret");
    800067b0:	30200073          	mret
}
...
{
    800067bc:	715d                	addi	sp,sp,-80
    800067be:	e486                	sd	ra,72(sp)
    800067c0:	e0a2                	sd	s0,64(sp)
    800067c2:	fc26                	sd	s1,56(sp)
    800067c4:	f84a                	sd	s2,48(sp)
    800067c6:	f44e                	sd	s3,40(sp)
    800067c8:	f052                	sd	s4,32(sp)
    800067ca:	ec56                	sd	s5,24(sp)
    800067cc:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    800067ce:	04c05663          	blez	a2,8000681a <consolewrite+0x5e>
    800067d2:	8a2a                	mv	s4,a0
    800067d4:	84ae                	mv	s1,a1
    800067d6:	89b2                	mv	s3,a2
    800067d8:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    800067da:	5afd                	li	s5,-1
    800067dc:	4685                	li	a3,1
    800067de:	8626                	mv	a2,s1
    800067e0:	85d2                	mv	a1,s4
    800067e2:	fbf40513          	addi	a0,s0,-65
    800067e6:	ffffb097          	auipc	ra,0xffffb
    800067ea:	170080e7          	jalr	368(ra) # 80001956 <either_copyin>
    800067ee:	01550c63          	beq	a0,s5,80006806 <consolewrite+0x4a>
      break;
    uartputc(c);
    800067f2:	fbf44503          	lbu	a0,-65(s0)
    800067f6:	00000097          	auipc	ra,0x0
    800067fa:	78e080e7          	jalr	1934(ra) # 80006f84 <uartputc>
  for(i = 0; i < n; i++){
    800067fe:	2905                	addiw	s2,s2,1
    80006800:	0485                	addi	s1,s1,1
    80006802:	fd299de3          	bne	s3,s2,800067dc <consolewrite+0x20>
  }

  return i;
}
    80006806:	854a                	mv	a0,s2
    80006808:	60a6                	ld	ra,72(sp)
    8000680a:	6406                	ld	s0,64(sp)
    8000680c:	74e2                	ld	s1,56(sp)
    8000680e:	7942                	ld	s2,48(sp)
    80006810:	79a2                	ld	s3,40(sp)
    80006812:	7a02                	ld	s4,32(sp)
    80006814:	6ae2                	ld	s5,24(sp)
    80006816:	6161                	addi	sp,sp,80
    80006818:	8082                	ret
  for(i = 0; i < n; i++){
    8000681a:	4901                	li	s2,0
    8000681c:	b7ed                	j	80006806 <consolewrite+0x4a>

000000008000681e <consoleread>:
...
{
    8000681e:	7119                	addi	sp,sp,-128
    80006820:	fc86                	sd	ra,120(sp)
    80006822:	f8a2                	sd	s0,112(sp)
    80006824:	f4a6                	sd	s1,104(sp)
    80006826:	f0ca                	sd	s2,96(sp)
    80006828:	ecce                	sd	s3,88(sp)
    8000682a:	e8d2                	sd	s4,80(sp)
    8000682c:	e4d6                	sd	s5,72(sp)
    8000682e:	e0da                	sd	s6,64(sp)
    80006830:	fc5e                	sd	s7,56(sp)
    80006832:	f862                	sd	s8,48(sp)
    80006834:	f466                	sd	s9,40(sp)
    80006836:	f06a                	sd	s10,32(sp)
    80006838:	ec6e                	sd	s11,24(sp)
    8000683a:	0100                	addi	s0,sp,128
    8000683c:	8b2a                	mv	s6,a0
    8000683e:	8aae                	mv	s5,a1
  ...
  target = n;
    80006842:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    80006846:	00021517          	auipc	a0,0x21
    8000684a:	c3a50513          	addi	a0,a0,-966 # 80027480 <cons>
    8000684e:	00001097          	auipc	ra,0x1
    80006852:	8f4080e7          	jalr	-1804(ra) # 80007142 <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    80006856:	00021497          	auipc	s1,0x21
    8000685a:	c2a48493          	addi	s1,s1,-982 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    8000685e:	89a6                	mv	s3,s1
    80006860:	00021917          	auipc	s2,0x21
    80006864:	cb890913          	addi	s2,s2,-840 # 80027518 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    80006868:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    8000686c:	4da9                	li	s11,10
  while(n > 0){
    8000686e:	07405863          	blez	s4,800068de <consoleread+0xc0>
    while(cons.r == cons.w){
    80006872:	0984a783          	lw	a5,152(s1)
    80006876:	09c4a703          	lw	a4,156(s1)
    8000687a:	02f71463          	bne	a4,a5,800068a2 <consoleread+0x84>
      if(myproc()->killed){
    8000687e:	ffffa097          	auipc	ra,0xffffa
    80006882:	622080e7          	jalr	1570(ra) # 80000ea0 <myproc>
    80006886:	551c                	lw	a5,40(a0)
    80006888:	e7b5                	bnez	a5,800068f4 <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    8000688a:	85ce                	mv	a1,s3
    8000688c:	854a                	mv	a0,s2
    8000688e:	ffffb097          	auipc	ra,0xffffb
    80006892:	cce080e7          	jalr	-818(ra) # 8000155c <sleep>
    while(cons.r == cons.w){
    80006896:	0984a783          	lw	a5,152(s1)
    8000689a:	09c4a703          	lw	a4,156(s1)
    8000689e:	fef700e3          	beq	a4,a5,8000687e <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    800068a2:	0017871b          	addiw	a4,a5,1
    800068a6:	08e4ac23          	sw	a4,152(s1)
    800068aa:	07f7f713          	andi	a4,a5,127
    800068ae:	9726                	add	a4,a4,s1
    800068b0:	01874703          	lbu	a4,24(a4)
    800068b4:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    800068b8:	079c0663          	beq	s8,s9,80006924 <consoleread+0x106>
    cbuf = c;
    800068bc:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    800068c0:	4685                	li	a3,1
    800068c2:	f8f40613          	addi	a2,s0,-113
    800068c6:	85d6                	mv	a1,s5
    800068c8:	855a                	mv	a0,s6
    800068ca:	ffffb097          	auipc	ra,0xffffb
    800068ce:	036080e7          	jalr	54(ra) # 80001900 <either_copyout>
    800068d2:	01a50663          	beq	a0,s10,800068de <consoleread+0xc0>
    dst++;
    800068d6:	0a85                	addi	s5,s5,1
    --n;
    800068d8:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    800068da:	f9bc1ae3          	bne	s8,s11,8000686e <consoleread+0x50>
  ...
  release(&cons.lock);
    ...
    800068e2:	ba250513          	addi	a0,a0,-1118 # 80027480 <cons>
    800068e6:	00001097          	auipc	ra,0x1
    800068ea:	910080e7          	jalr	-1776(ra) # 800071f6 <release>

  return target - n;
    800068ee:	414b853b          	subw	a0,s7,s4
    800068f2:	a811                	j	80006906 <consoleread+0xe8>
        release(&cons.lock);
    800068f4:	00021517          	auipc	a0,0x21
    800068f8:	b8c50513          	addi	a0,a0,-1140 # 80027480 <cons>
    800068fc:	00001097          	auipc	ra,0x1
    80006900:	8fa080e7          	jalr	-1798(ra) # 800071f6 <release>
        return -1;
    80006904:	557d                	li	a0,-1
}
    80006906:	70e6                	ld	ra,120(sp)
    80006908:	7446                	ld	s0,112(sp)
    8000690a:	74a6                	ld	s1,104(sp)
    8000690c:	7906                	ld	s2,96(sp)
    8000690e:	69e6                	ld	s3,88(sp)
    80006910:	6a46                	ld	s4,80(sp)
    80006912:	6aa6                	ld	s5,72(sp)
    80006914:	6b06                	ld	s6,64(sp)
    80006916:	7be2                	ld	s7,56(sp)
    80006918:	7c42                	ld	s8,48(sp)
    8000691a:	7ca2                	ld	s9,40(sp)
    8000691c:	7d02                	ld	s10,32(sp)
    8000691e:	6de2                	ld	s11,24(sp)
    80006920:	6109                	addi	sp,sp,128
    80006922:	8082                	ret
      if(n < target){
    80006924:	000a071b          	sext.w	a4,s4
    80006928:	fb777be3          	bgeu	a4,s7,800068de <consoleread+0xc0>
        cons.r--;
    8000692c:	00021717          	auipc	a4,0x21
    80006930:	bef72623          	sw	a5,-1044(a4) # 80027518 <cons+0x98>
    80006934:	b76d                	j	800068de <consoleread+0xc0>

0000000080006936 <consputc>:
{
  ...
  if(c == BACKSPACE){
    8000693e:	10000793          	li	a5,256
    80006942:	00f50a63          	beq	a0,a5,80006956 <consputc+0x20>
    uartputc_sync(c);
    80006946:	00000097          	auipc	ra,0x0
    8000694a:	564080e7          	jalr	1380(ra) # 80006eaa <uartputc_sync>
}
    8000694e:	60a2                	ld	ra,8(sp)
    80006950:	6402                	ld	s0,0(sp)
    80006952:	0141                	addi	sp,sp,16
    80006954:	8082                	ret
    uartputc_sync('\b'); uartputc_sync(' '); uartputc_sync('\b');
    80006956:	4521                	li	a0,8
    80006958:	00000097          	auipc	ra,0x0
    8000695c:	552080e7          	jalr	1362(ra) # 80006eaa <uartputc_sync>
    80006960:	02000513          	li	a0,32
    80006964:	00000097          	auipc	ra,0x0
    80006968:	546080e7          	jalr	1350(ra) # 80006eaa <uartputc_sync>
    8000696c:	4521                	li	a0,8
    8000696e:	00000097          	auipc	ra,0x0
    80006972:	53c080e7          	jalr	1340(ra) # 80006eaa <uartputc_sync>
    80006976:	bfe1                	j	8000694e <consputc+0x18>

0000000080006978 <consoleintr>:
...
consoleintr(int c)
{
    ...
    80006984:	84aa                	mv	s1,a0
  acquire(&cons.lock);
    80006986:	00021517          	auipc	a0,0x21
    8000698a:	afa50513          	addi	a0,a0,-1286 # 80027480 <cons>
    8000698e:	00000097          	auipc	ra,0x0
    80006992:	7b4080e7          	jalr	1972(ra) # 80007142 <acquire>

  switch(c){
    80006996:	47d5                	li	a5,21
    80006998:	0af48663          	beq	s1,a5,80006a44 <consoleintr+0xcc>
    8000699c:	0297ca63          	blt	a5,s1,800069d0 <consoleintr+0x58>
    800069a0:	47a1                	li	a5,8
    800069a2:	0ef48763          	beq	s1,a5,80006a90 <consoleintr+0x118>
    800069a6:	47c1                	li	a5,16
    800069a8:	10f49a63          	bne	s1,a5,80006abc <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    800069ac:	ffffb097          	auipc	ra,0xffffb
    800069b0:	000080e7          	jalr	ra # 800019ac <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    800069b4:	00021517          	auipc	a0,0x21
    800069b8:	acc50513          	addi	a0,a0,-1332 # 80027480 <cons>
    800069bc:	00001097          	auipc	ra,0x1
    800069c0:	83a080e7          	jalr	-1990(ra) # 800071f6 <release>
}
    800069c4:	60e2                	ld	ra,24(sp)
    800069c6:	6442                	ld	s0,16(sp)
    800069c8:	64a2                	ld	s1,8(sp)
    800069ca:	6902                	ld	s2,0(sp)
    800069cc:	6105                	addi	sp,sp,32
    800069ce:	8082                	ret
  switch(c){
    800069d0:	07f00793          	li	a5,127
    800069d4:	0af48e63          	beq	s1,a5,80006a90 <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    800069d8:	00021717          	auipc	a4,0x21
    800069dc:	aa870713          	addi	a4,a4,-1368 # 80027480 <cons>
    800069e0:	0a072783          	lw	a5,160(a4)
    800069e4:	09872703          	lw	a4,152(a4)
    800069e8:	9f99                	subw	a5,a5,a4
    800069ea:	07f00713          	li	a4,127
    800069ee:	fcf763e3          	bltu	a4,a5,800069b4 <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    800069f2:	47b5                	li	a5,13
    800069f4:	0cf48763          	beq	s1,a5,80006ac2 <consoleintr+0x14a>
      consputc(c);
    800069f8:	8526                	mv	a0,s1
    800069fa:	00000097          	auipc	ra,0x0
    800069fe:	f3c080e7          	jalr	-196(ra) # 80006936 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a02:	00021797          	auipc	a5,0x21
    80006a06:	a7e78793          	addi	a5,a5,-1410 # 80027480 <cons>
    80006a0a:	0a07a703          	lw	a4,160(a5)
    80006a0e:	0017069b          	addiw	a3,a4,1
    80006a12:	0006861b          	sext.w	a2,a3
    80006a16:	0ad7a023          	sw	a3,160(a5)
    80006a1a:	07f77713          	andi	a4,a4,127
    80006a1e:	97ba                	add	a5,a5,a4
    80006a20:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    80006a24:	47a9                	li	a5,10
    80006a26:	0cf48563          	beq	s1,a5,80006af0 <consoleintr+0x178>
    80006a2a:	4791                	li	a5,4
    80006a2c:	0cf48263          	beq	s1,a5,80006af0 <consoleintr+0x178>
    80006a30:	00021797          	auipc	a5,0x21
    80006a34:	ae87a783          	lw	a5,-1304(a5) # 80027518 <cons+0x98>
    80006a38:	0807879b          	addiw	a5,a5,128
    80006a3c:	f6f61ce3          	bne	a2,a5,800069b4 <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a40:	863e                	mv	a2,a5
    80006a42:	a07d                	j	80006af0 <consoleintr+0x178>
    while(cons.e != cons.w &&
    80006a44:	00021717          	auipc	a4,0x21
    80006a48:	a3c70713          	addi	a4,a4,-1476 # 80027480 <cons>
    80006a4c:	0a072783          	lw	a5,160(a4)
    80006a50:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a54:	00021497          	auipc	s1,0x21
    80006a58:	a2c48493          	addi	s1,s1,-1492 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a5c:	4929                	li	s2,10
    80006a5e:	f4f70be3          	beq	a4,a5,800069b4 <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a62:	37fd                	addiw	a5,a5,-1
    80006a64:	07f7f713          	andi	a4,a5,127
    80006a68:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a6a:	01874703          	lbu	a4,24(a4)
    80006a6e:	f52703e3          	beq	a4,s2,800069b4 <consoleintr+0x3c>
      cons.e--;
    80006a72:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006a76:	10000513          	li	a0,256
    80006a7a:	00000097          	auipc	ra,0x0
    80006a7e:	ebc080e7          	jalr	-324(ra) # 80006936 <consputc>
    while(cons.e != cons.w &&
    80006a82:	0a04a783          	lw	a5,160(s1)
    80006a86:	09c4a703          	lw	a4,156(s1)
    80006a8a:	fcf71ce3          	bne	a4,a5,80006a62 <consoleintr+0xea>
    80006a8e:	b71d                	j	800069b4 <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006a90:	00021717          	auipc	a4,0x21
    80006a94:	9f070713          	addi	a4,a4,-1552 # 80027480 <cons>
    80006a98:	0a072783          	lw	a5,160(a4)
    80006a9c:	09c72703          	lw	a4,156(a4)
    80006aa0:	f0f70ae3          	beq	a4,a5,800069b4 <consoleintr+0x3c>
      cons.e--;
    80006aa4:	37fd                	addiw	a5,a5,-1
    80006aa6:	00021717          	auipc	a4,0x21
    80006aaa:	a6f72d23          	sw	a5,-1414(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006aae:	10000513          	li	a0,256
    80006ab2:	00000097          	auipc	ra,0x0
    80006ab6:	e84080e7          	jalr	-380(ra) # 80006936 <consputc>
    80006aba:	bded                	j	800069b4 <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006abc:	ee048ce3          	beqz	s1,800069b4 <consoleintr+0x3c>
    80006ac0:	bf21                	j	800069d8 <consoleintr+0x60>
      consputc(c);
    80006ac2:	4529                	li	a0,10
    80006ac4:	00000097          	auipc	ra,0x0
    80006ac8:	e72080e7          	jalr	-398(ra) # 80006936 <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006acc:	00021797          	auipc	a5,0x21
    80006ad0:	9b478793          	addi	a5,a5,-1612 # 80027480 <cons>
    80006ad4:	0a07a703          	lw	a4,160(a5)
    80006ad8:	0017069b          	addiw	a3,a4,1
    80006adc:	0006861b          	sext.w	a2,a3
    80006ae0:	0ad7a023          	sw	a3,160(a5)
    80006ae4:	07f77713          	andi	a4,a4,127
    80006ae8:	97ba                	add	a5,a5,a4
    80006aea:	4729                	li	a4,10
    80006aec:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006af0:	00021797          	auipc	a5,0x21
    80006af4:	a2c7a623          	sw	a2,-1492(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006af8:	00021517          	auipc	a0,0x21
    80006afc:	a2050513          	addi	a0,a0,-1504 # 80027518 <cons+0x98>
    80006b00:	ffffb097          	auipc	ra,0xffffb
    80006b04:	be8080e7          	jalr	-1048(ra) # 800016e8 <wakeup>
    80006b08:	b575                	j	800069b4 <consoleintr+0x3c>

0000000080006b0a <consoleinit>:

void
consoleinit(void)
{
    80006b0a:	1141                	addi	sp,sp,-16
    80006b0c:	e406                	sd	ra,8(sp)
    80006b0e:	e022                	sd	s0,0(sp)
    80006b10:	0800                	addi	s0,sp,16
  initlock(&cons.lock, "cons");
    80006b12:	00003597          	auipc	a1,0x3
    80006b16:	cfe58593          	addi	a1,a1,-770 # 80009810 <syscalls+0x438>
    80006b1a:	00021517          	auipc	a0,0x21
    80006b1e:	96650513          	addi	a0,a0,-1690 # 80027480 <cons>
    80006b22:	00000097          	auipc	ra,0x0
    80006b26:	590080e7          	jalr	1424(ra) # 800070b2 <initlock>

  uartinit();
    80006b2a:	00000097          	auipc	ra,0x0
    80006b2e:	330080e7          	jalr	816(ra) # 80006e5a <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006b32:	00013797          	auipc	a5,0x13
    80006b36:	5b678793          	addi	a5,a5,1462 # 8001a0e8 <devsw>
    80006b3a:	00000717          	auipc	a4,0x0
    80006b3e:	ce470713          	addi	a4,a4,-796 # 8000681e <consoleread>
    80006b42:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b44:	00000717          	auipc	a4,0x0
    80006b48:	c7870713          	addi	a4,a4,-904 # 800067bc <consolewrite>
    80006b4c:	ef98                	sd	a4,24(a5)
}
...
{
    80006b56:	7179                	addi	sp,sp,-48
    80006b58:	f406                	sd	ra,40(sp)
    80006b5a:	f022                	sd	s0,32(sp)
    80006b5c:	ec26                	sd	s1,24(sp)
    80006b5e:	e84a                	sd	s2,16(sp)
    80006b60:	1800                	addi	s0,sp,48
  char buf[16];
  int i;
  uint x;

  if(sign && (sign = xx < 0))
    80006b62:	c219                	beqz	a2,80006b68 <printint+0x12>
    80006b64:	08054663          	bltz	a0,80006bf0 <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b68:	2501                	sext.w	a0,a0
    80006b6a:	4881                	li	a7,0
    80006b6c:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b70:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b72:	2581                	sext.w	a1,a1
    80006b74:	00003617          	auipc	a2,0x3
    80006b78:	ccc60613          	addi	a2,a2,-820 # 80009840 <digits>
    80006b7c:	883a                	mv	a6,a4
    80006b7e:	2705                	addiw	a4,a4,1
    80006b80:	02b577bb          	remuw	a5,a0,a1
    80006b84:	1782                	slli	a5,a5,0x20
    80006b86:	9381                	srli	a5,a5,0x20
    80006b88:	97b2                	add	a5,a5,a2
    80006b8a:	0007c783          	lbu	a5,0(a5)
    80006b8e:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006b92:	0005079b          	sext.w	a5,a0
    80006b96:	02b5553b          	divuw	a0,a0,a1
    80006b9a:	0685                	addi	a3,a3,1
    80006b9c:	feb7f0e3          	bgeu	a5,a1,80006b7c <printint+0x26>

  if(sign)
    80006ba0:	00088b63          	beqz	a7,80006bb6 <printint+0x60>
    buf[i++] = '-';
    80006ba4:	fe040793          	addi	a5,s0,-32
    80006ba8:	973e                	add	a4,a4,a5
    80006baa:	02d00793          	li	a5,45
    80006bae:	fef70823          	sb	a5,-16(a4)
    80006bb2:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006bb6:	02e05763          	blez	a4,80006be4 <printint+0x8e>
    80006bba:	fd040793          	addi	a5,s0,-48
    80006bbe:	00e784b3          	add	s1,a5,a4
    80006bc2:	fff78913          	addi	s2,a5,-1
    80006bc6:	993a                	add	s2,s2,a4
    80006bc8:	377d                	addiw	a4,a4,-1
    80006bca:	1702                	slli	a4,a4,0x20
    80006bcc:	9301                	srli	a4,a4,0x20
    80006bce:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006bd2:	fff4c503          	lbu	a0,-1(s1)
    80006bd6:	00000097          	auipc	ra,0x0
    80006bda:	d60080e7          	jalr	-672(ra) # 80006936 <consputc>
  while(--i >= 0)
    80006bde:	14fd                	addi	s1,s1,-1
    80006be0:	ff2499e3          	bne	s1,s2,80006bd2 <printint+0x7c>
}
    80006be4:	70a2                	ld	ra,40(sp)
    80006be6:	7402                	ld	s0,32(sp)
    80006be8:	64e2                	ld	s1,24(sp)
    80006bea:	6942                	ld	s2,16(sp)
    80006bec:	6145                	addi	sp,sp,48
    80006bee:	8082                	ret
    x = -xx;
    80006bf0:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006bf4:	4885                	li	a7,1
    x = -xx;
    80006bf6:	bf9d                	j	80006b6c <printint+0x16>

0000000080006bf8 <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
    ...
    80006c00:	1000                	addi	s0,sp,32
    80006c02:	84aa                	mv	s1,a0
  pr.locking = 0;
    80006c04:	00021797          	auipc	a5,0x21
    80006c08:	9207ae23          	sw	zero,-1732(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006c0c:	00003517          	auipc	a0,0x3
    80006c10:	c0c50513          	addi	a0,a0,-1012 # 80009818 <syscalls+0x440>
    80006c14:	00000097          	auipc	ra,0x0
    80006c18:	02e080e7          	jalr	46(ra) # 80006c42 <printf>
  printf(s);
    80006c1c:	8526                	mv	a0,s1
    80006c1e:	00000097          	auipc	ra,0x0
    80006c22:	024080e7          	jalr	36(ra) # 80006c42 <printf>
  printf("\n");
    80006c26:	00002517          	auipc	a0,0x2
    80006c2a:	42250513          	addi	a0,a0,1058 # 80009048 <etext+0x48>
    80006c2e:	00000097          	auipc	ra,0x0
    80006c32:	014080e7          	jalr	20(ra) # 80006c42 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006c36:	4785                	li	a5,1
    80006c38:	00003717          	auipc	a4,0x3
    80006c3c:	3ef72c23          	sw	a5,1016(a4) # 8000a030 <panicked>
  for(;;)
    80006c40:	a001                	j	80006c40 <panic+0x48>

0000000080006c42 <printf>:
{
    80006c42:	7131                	addi	sp,sp,-192
    80006c44:	fc86                	sd	ra,120(sp)
    80006c46:	f8a2                	sd	s0,112(sp)
    80006c48:	f4a6                	sd	s1,104(sp)
    80006c4a:	f0ca                	sd	s2,96(sp)
    80006c4c:	ecce                	sd	s3,88(sp)
    80006c4e:	e8d2                	sd	s4,80(sp)
    80006c50:	e4d6                	sd	s5,72(sp)
    80006c52:	e0da                	sd	s6,64(sp)
    80006c54:	fc5e                	sd	s7,56(sp)
    80006c56:	f862                	sd	s8,48(sp)
    80006c58:	f466                	sd	s9,40(sp)
    80006c5a:	f06a                	sd	s10,32(sp)
    80006c5c:	ec6e                	sd	s11,24(sp)
    80006c5e:	0100                	addi	s0,sp,128
    80006c60:	8a2a                	mv	s4,a0
    80006c62:	e40c                	sd	a1,8(s0)
    80006c64:	e810                	sd	a2,16(s0)
    80006c66:	ec14                	sd	a3,24(s0)
    80006c68:	f018                	sd	a4,32(s0)
    80006c6a:	f41c                	sd	a5,40(s0)
    80006c6c:	03043823          	sd	a6,48(s0)
    80006c70:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006c74:	00021d97          	auipc	s11,0x21
    80006c78:	8ccdad83          	lw	s11,-1844(s11) # 80027540 <pr+0x18>
  if(locking)
    80006c7c:	020d9b63          	bnez	s11,80006cb2 <printf+0x70>
  if (fmt == 0)
    80006c80:	040a0263          	beqz	s4,80006cc4 <printf+0x82>
  va_start(ap, fmt);
    80006c84:	00840793          	addi	a5,s0,8
    80006c88:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006c8c:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006c90:	16050263          	beqz	a0,80006df4 <printf+0x1b2>
    80006c94:	4481                	li	s1,0
    if(c != '%'){
    80006c96:	02500a93          	li	s5,37
    switch(c){
    80006c9a:	07000b13          	li	s6,112
  consputc('x');
    80006c9e:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006ca0:	00003b97          	auipc	s7,0x3
    80006ca4:	ba0b8b93          	addi	s7,s7,-1120 # 80009840 <digits>
    switch(c){
    80006ca8:	07300c93          	li	s9,115
    80006cac:	06400c13          	li	s8,100
    80006cb0:	a82d                	j	80006cea <printf+0xa8>
    acquire(&pr.lock);
    80006cb2:	00021517          	auipc	a0,0x21
    80006cb6:	87650513          	addi	a0,a0,-1930 # 80027528 <pr>
    80006cba:	00000097          	auipc	ra,0x0
    80006cbe:	488080e7          	jalr	1160(ra) # 80007142 <acquire>
    80006cc2:	bf7d                	j	80006c80 <printf+0x3e>
    panic("null fmt");
    80006cc4:	00003517          	auipc	a0,0x3
    80006cc8:	b6450513          	addi	a0,a0,-1180 # 80009828 <syscalls+0x450>
    80006ccc:	00000097          	auipc	ra,0x0
    80006cd0:	f2c080e7          	jalr	-212(ra) # 80006bf8 <panic>
      consputc(c);
    80006cd4:	00000097          	auipc	ra,0x0
    80006cd8:	c62080e7          	jalr	-926(ra) # 80006936 <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006cdc:	2485                	addiw	s1,s1,1
    80006cde:	009a07b3          	add	a5,s4,s1
    80006ce2:	0007c503          	lbu	a0,0(a5)
    80006ce6:	10050763          	beqz	a0,80006df4 <printf+0x1b2>
    if(c != '%'){
    80006cea:	ff5515e3          	bne	a0,s5,80006cd4 <printf+0x92>
    c = fmt[++i] & 0xff;
    80006cee:	2485                	addiw	s1,s1,1
    80006cf0:	009a07b3          	add	a5,s4,s1
    80006cf4:	0007c783          	lbu	a5,0(a5)
    80006cf8:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006cfc:	cfe5                	beqz	a5,80006df4 <printf+0x1b2>
    switch(c){
    80006cfe:	05678a63          	beq	a5,s6,80006d52 <printf+0x110>
    80006d02:	02fb7663          	bgeu	s6,a5,80006d2e <printf+0xec>
    80006d06:	09978963          	beq	a5,s9,80006d98 <printf+0x156>
    80006d0a:	07800713          	li	a4,120
    80006d0e:	0ce79863          	bne	a5,a4,80006dde <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006d12:	f8843783          	ld	a5,-120(s0)
    80006d16:	00878713          	addi	a4,a5,8
    80006d1a:	f8e43423          	sd	a4,-120(s0)
    80006d1e:	4605                	li	a2,1
    80006d20:	85ea                	mv	a1,s10
    80006d22:	4388                	lw	a0,0(a5)
    80006d24:	00000097          	auipc	ra,0x0
    80006d28:	e32080e7          	jalr	-462(ra) # 80006b56 <printint>
      break;
    80006d2c:	bf45                	j	80006cdc <printf+0x9a>
    switch(c){
    80006d2e:	0b578263          	beq	a5,s5,80006dd2 <printf+0x190>
    80006d32:	0b879663          	bne	a5,s8,80006dde <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006d36:	f8843783          	ld	a5,-120(s0)
    80006d3a:	00878713          	addi	a4,a5,8
    80006d3e:	f8e43423          	sd	a4,-120(s0)
    80006d42:	4605                	li	a2,1
    80006d44:	45a9                	li	a1,10
    80006d46:	4388                	lw	a0,0(a5)
    80006d48:	00000097          	auipc	ra,0x0
    80006d4c:	e0e080e7          	jalr	-498(ra) # 80006b56 <printint>
      break;
    80006d50:	b771                	j	80006cdc <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d52:	f8843783          	ld	a5,-120(s0)
    80006d56:	00878713          	addi	a4,a5,8
    80006d5a:	f8e43423          	sd	a4,-120(s0)
    80006d5e:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d62:	03000513          	li	a0,48
    80006d66:	00000097          	auipc	ra,0x0
    80006d6a:	bd0080e7          	jalr	-1072(ra) # 80006936 <consputc>
  consputc('x');
    80006d6e:	07800513          	li	a0,120
    80006d72:	00000097          	auipc	ra,0x0
    80006d76:	bc4080e7          	jalr	-1084(ra) # 80006936 <consputc>
    80006d7a:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006d7c:	03c9d793          	srli	a5,s3,0x3c
    80006d80:	97de                	add	a5,a5,s7
    80006d82:	0007c503          	lbu	a0,0(a5)
    80006d86:	00000097          	auipc	ra,0x0
    80006d8a:	bb0080e7          	jalr	-1104(ra) # 80006936 <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006d8e:	0992                	slli	s3,s3,0x4
    80006d90:	397d                	addiw	s2,s2,-1
    80006d92:	fe0915e3          	bnez	s2,80006d7c <printf+0x13a>
    80006d96:	b799                	j	80006cdc <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006d98:	f8843783          	ld	a5,-120(s0)
    80006d9c:	00878713          	addi	a4,a5,8
    80006da0:	f8e43423          	sd	a4,-120(s0)
    80006da4:	0007b903          	ld	s2,0(a5)
    80006da8:	00090e63          	beqz	s2,80006dc4 <printf+0x182>
      for(; *s; s++)
    80006dac:	00094503          	lbu	a0,0(s2)
    80006db0:	d515                	beqz	a0,80006cdc <printf+0x9a>
        consputc(*s);
    80006db2:	00000097          	auipc	ra,0x0
    80006db6:	b84080e7          	jalr	-1148(ra) # 80006936 <consputc>
      for(; *s; s++)
    80006dba:	0905                	addi	s2,s2,1
    80006dbc:	00094503          	lbu	a0,0(s2)
    80006dc0:	f96d                	bnez	a0,80006db2 <printf+0x170>
    80006dc2:	bf29                	j	80006cdc <printf+0x9a>
        s = "(null)";
    80006dc4:	00003917          	auipc	s2,0x3
    80006dc8:	a5c90913          	addi	s2,s2,-1444 # 80009820 <syscalls+0x448>
      for(; *s; s++)
    80006dcc:	02800513          	li	a0,40
    80006dd0:	b7cd                	j	80006db2 <printf+0x170>
      consputc('%');
    80006dd2:	8556                	mv	a0,s5
    80006dd4:	00000097          	auipc	ra,0x0
    80006dd8:	b62080e7          	jalr	-1182(ra) # 80006936 <consputc>
      break;
    80006ddc:	b701                	j	80006cdc <printf+0x9a>
      consputc('%');
    80006dde:	8556                	mv	a0,s5
    80006de0:	00000097          	auipc	ra,0x0
    80006de4:	b56080e7          	jalr	-1194(ra) # 80006936 <consputc>
      consputc(c);
    80006de8:	854a                	mv	a0,s2
    80006dea:	00000097          	auipc	ra,0x0
    80006dee:	b4c080e7          	jalr	-1204(ra) # 80006936 <consputc>
      break;
    80006df2:	b5ed                	j	80006cdc <printf+0x9a>
  if(locking)
    80006df4:	020d9163          	bnez	s11,80006e16 <printf+0x1d4>
}
    80006df8:	70e6                	ld	ra,120(sp)
    80006dfa:	7446                	ld	s0,112(sp)
    80006dfc:	74a6                	ld	s1,104(sp)
    80006dfe:	7906                	ld	s2,96(sp)
    80006e00:	69e6                	ld	s3,88(sp)
    80006e02:	6a46                	ld	s4,80(sp)
    80006e04:	6aa6                	ld	s5,72(sp)
    80006e06:	6b06                	ld	s6,64(sp)
    80006e08:	7be2                	ld	s7,56(sp)
    80006e0a:	7c42                	ld	s8,48(sp)
    80006e0c:	7ca2                	ld	s9,40(sp)
    80006e0e:	7d02                	ld	s10,32(sp)
    80006e10:	6de2                	ld	s11,24(sp)
    80006e12:	6129                	addi	sp,sp,192
    80006e14:	8082                	ret
    release(&pr.lock);
    80006e16:	00020517          	auipc	a0,0x20
    80006e1a:	71250513          	addi	a0,a0,1810 # 80027528 <pr>
    80006e1e:	00000097          	auipc	ra,0x0
    80006e22:	3d8080e7          	jalr	984(ra) # 800071f6 <release>
}
    80006e26:	bfc9                	j	80006df8 <printf+0x1b6>

0000000080006e28 <printfinit>:
    ;
}
...
printfinit(void)
{
    ...
    80006e2e:	e426                	sd	s1,8(sp)
    80006e30:	1000                	addi	s0,sp,32
  initlock(&pr.lock, "pr");
    80006e32:	00020497          	auipc	s1,0x20
    80006e36:	6f648493          	addi	s1,s1,1782 # 80027528 <pr>
    80006e3a:	00003597          	auipc	a1,0x3
    80006e3e:	9fe58593          	addi	a1,a1,-1538 # 80009838 <syscalls+0x460>
    80006e42:	8526                	mv	a0,s1
    80006e44:	00000097          	auipc	ra,0x0
    80006e48:	26e080e7          	jalr	622(ra) # 800070b2 <initlock>
  pr.locking = 1;
    80006e4c:	4785                	li	a5,1
    80006e4e:	cc9c                	sw	a5,24(s1)
}
...
uartinit(void)
{
    ...
    80006e5c:	e406                	sd	ra,8(sp)
    80006e5e:	e022                	sd	s0,0(sp)
    80006e60:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e62:	100007b7          	lui	a5,0x10000
    80006e66:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e6a:	f8000713          	li	a4,-128
    80006e6e:	00e781a3          	sb	a4,3(a5)
  ...
  WriteReg(1, 0x00);
    80006e78:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006e7c:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006e80:	469d                	li	a3,7
    80006e82:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006e86:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006e8a:	00003597          	auipc	a1,0x3
    80006e8e:	9ce58593          	addi	a1,a1,-1586 # 80009858 <digits+0x18>
    80006e92:	00020517          	auipc	a0,0x20
    80006e96:	6b650513          	addi	a0,a0,1718 # 80027548 <uart_tx_lock>
    80006e9a:	00000097          	auipc	ra,0x0
    80006e9e:	218080e7          	jalr	536(ra) # 800070b2 <initlock>
}
    80006ea2:	60a2                	ld	ra,8(sp)
    80006ea4:	6402                	ld	s0,0(sp)
    80006ea6:	0141                	addi	sp,sp,16
    80006ea8:	8082                	ret

0000000080006eaa <uartputc_sync>:
...
uartputc_sync(int c)
{
    80006eaa:	1101                	addi	sp,sp,-32
    80006eac:	ec06                	sd	ra,24(sp)
    80006eae:	e822                	sd	s0,16(sp)
    80006eb0:	e426                	sd	s1,8(sp)
    80006eb2:	1000                	addi	s0,sp,32
    80006eb4:	84aa                	mv	s1,a0
  push_off();
    80006eb6:	00000097          	auipc	ra,0x0
    80006eba:	240080e7          	jalr	576(ra) # 800070f6 <push_off>

  if(panicked){
    80006ebe:	00003797          	auipc	a5,0x3
    80006ec2:	1727a783          	lw	a5,370(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006ec6:	10000737          	lui	a4,0x10000
  if(panicked){
    80006eca:	c391                	beqz	a5,80006ece <uartputc_sync+0x24>
    for(;;)
    80006ecc:	a001                	j	80006ecc <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006ece:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006ed2:	0ff7f793          	andi	a5,a5,255
    80006ed6:	0207f793          	andi	a5,a5,32
    80006eda:	dbf5                	beqz	a5,80006ece <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006edc:	0ff4f793          	andi	a5,s1,255
    80006ee0:	10000737          	lui	a4,0x10000
    80006ee4:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006ee8:	00000097          	auipc	ra,0x0
    80006eec:	2ae080e7          	jalr	686(ra) # 80007196 <pop_off>
}
...
uartstart()
{
  while(1){
    ...
    80006efa:	00003717          	auipc	a4,0x3
    80006efe:	13e73703          	ld	a4,318(a4) # 8000a038 <uart_tx_r>
    80006f02:	00003797          	auipc	a5,0x3
    80006f06:	13e7b783          	ld	a5,318(a5) # 8000a040 <uart_tx_w>
    80006f0a:	06e78c63          	beq	a5,a4,80006f82 <uartstart+0x88>
{
    80006f0e:	7139                	addi	sp,sp,-64
    80006f10:	fc06                	sd	ra,56(sp)
    80006f12:	f822                	sd	s0,48(sp)
    80006f14:	f426                	sd	s1,40(sp)
    80006f16:	f04a                	sd	s2,32(sp)
    80006f18:	ec4e                	sd	s3,24(sp)
    80006f1a:	e852                	sd	s4,16(sp)
    80006f1c:	e456                	sd	s5,8(sp)
    80006f1e:	0080                	addi	s0,sp,64
      // transmit buffer is empty.
      return;
    }
    
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f20:	10000937          	lui	s2,0x10000
    ...
    80006f24:	00020a17          	auipc	s4,0x20
    80006f28:	624a0a13          	addi	s4,s4,1572 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006f2c:	00003497          	auipc	s1,0x3
    80006f30:	10c48493          	addi	s1,s1,268 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006f34:	00003997          	auipc	s3,0x3
    80006f38:	10c98993          	addi	s3,s3,268 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f3c:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f40:	0ff7f793          	andi	a5,a5,255
    80006f44:	0207f793          	andi	a5,a5,32
    80006f48:	c785                	beqz	a5,80006f70 <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f4a:	01f77793          	andi	a5,a4,31
    80006f4e:	97d2                	add	a5,a5,s4
    80006f50:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f54:	0705                	addi	a4,a4,1
    80006f56:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f58:	8526                	mv	a0,s1
    80006f5a:	ffffa097          	auipc	ra,0xffffa
    80006f5e:	78e080e7          	jalr	1934(ra) # 800016e8 <wakeup>
    
    WriteReg(THR, c);
    80006f62:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f66:	6098                	ld	a4,0(s1)
    80006f68:	0009b783          	ld	a5,0(s3)
    80006f6c:	fce798e3          	bne	a5,a4,80006f3c <uartstart+0x42>
  }
}
    80006f70:	70e2                	ld	ra,56(sp)
    80006f72:	7442                	ld	s0,48(sp)
    80006f74:	74a2                	ld	s1,40(sp)
    80006f76:	7902                	ld	s2,32(sp)
    80006f78:	69e2                	ld	s3,24(sp)
    80006f7a:	6a42                	ld	s4,16(sp)
    80006f7c:	6aa2                	ld	s5,8(sp)
    80006f7e:	6121                	addi	sp,sp,64
    80006f80:	8082                	ret
    80006f82:	8082                	ret

0000000080006f84 <uartputc>:
{
    80006f84:	7179                	addi	sp,sp,-48
    80006f86:	f406                	sd	ra,40(sp)
    80006f88:	f022                	sd	s0,32(sp)
    80006f8a:	ec26                	sd	s1,24(sp)
    80006f8c:	e84a                	sd	s2,16(sp)
    80006f8e:	e44e                	sd	s3,8(sp)
    80006f90:	e052                	sd	s4,0(sp)
    80006f92:	1800                	addi	s0,sp,48
    80006f94:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006f96:	00020517          	auipc	a0,0x20
    80006f9a:	5b250513          	addi	a0,a0,1458 # 80027548 <uart_tx_lock>
    80006f9e:	00000097          	auipc	ra,0x0
    80006fa2:	1a4080e7          	jalr	420(ra) # 80007142 <acquire>
  if(panicked){
    80006fa6:	00003797          	auipc	a5,0x3
    80006faa:	08a7a783          	lw	a5,138(a5) # 8000a030 <panicked>
    80006fae:	c391                	beqz	a5,80006fb2 <uartputc+0x2e>
    for(;;)
    80006fb0:	a001                	j	80006fb0 <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fb2:	00003797          	auipc	a5,0x3
    80006fb6:	08e7b783          	ld	a5,142(a5) # 8000a040 <uart_tx_w>
    80006fba:	00003717          	auipc	a4,0x3
    80006fbe:	07e73703          	ld	a4,126(a4) # 8000a038 <uart_tx_r>
    80006fc2:	02070713          	addi	a4,a4,32
    80006fc6:	02f71b63          	bne	a4,a5,80006ffc <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fca:	00020a17          	auipc	s4,0x20
    80006fce:	57ea0a13          	addi	s4,s4,1406 # 80027548 <uart_tx_lock>
    80006fd2:	00003497          	auipc	s1,0x3
    80006fd6:	06648493          	addi	s1,s1,102 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fda:	00003917          	auipc	s2,0x3
    80006fde:	06690913          	addi	s2,s2,102 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fe2:	85d2                	mv	a1,s4
    80006fe4:	8526                	mv	a0,s1
    80006fe6:	ffffa097          	auipc	ra,0xffffa
    80006fea:	576080e7          	jalr	1398(ra) # 8000155c <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fee:	00093783          	ld	a5,0(s2)
    80006ff2:	6098                	ld	a4,0(s1)
    80006ff4:	02070713          	addi	a4,a4,32
    80006ff8:	fef705e3          	beq	a4,a5,80006fe2 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80006ffc:	00020497          	auipc	s1,0x20
    80007000:	54c48493          	addi	s1,s1,1356 # 80027548 <uart_tx_lock>
    80007004:	01f7f713          	andi	a4,a5,31
    80007008:	9726                	add	a4,a4,s1
    8000700a:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    8000700e:	0785                	addi	a5,a5,1
    80007010:	00003717          	auipc	a4,0x3
    80007014:	02f73823          	sd	a5,48(a4) # 8000a040 <uart_tx_w>
      uartstart();
    80007018:	00000097          	auipc	ra,0x0
    8000701c:	ee2080e7          	jalr	-286(ra) # 80006efa <uartstart>
      release(&uart_tx_lock);
    80007020:	8526                	mv	a0,s1
    80007022:	00000097          	auipc	ra,0x0
    80007026:	1d4080e7          	jalr	468(ra) # 800071f6 <release>
}
    8000702a:	70a2                	ld	ra,40(sp)
    8000702c:	7402                	ld	s0,32(sp)
    8000702e:	64e2                	ld	s1,24(sp)
    80007030:	6942                	ld	s2,16(sp)
    80007032:	69a2                	ld	s3,8(sp)
    80007034:	6a02                	ld	s4,0(sp)
    80007036:	6145                	addi	sp,sp,48
    80007038:	8082                	ret

000000008000703a <uartgetc>:
...
uartgetc(void)
{
  ...
  if(ReadReg(LSR) & 0x01){
    ...
    80007048:	8b85                	andi	a5,a5,1
    8000704a:	cb91                	beqz	a5,8000705e <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    8000704c:	100007b7          	lui	a5,0x10000
    80007050:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    80007054:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    80007058:	6422                	ld	s0,8(sp)
    8000705a:	0141                	addi	sp,sp,16
    8000705c:	8082                	ret
    return -1;
    8000705e:	557d                	li	a0,-1
    80007060:	bfe5                	j	80007058 <uartgetc+0x1e>

0000000080007062 <uartintr>:
...
uartintr(void)
{
  ...
  while(1){
    int c = uartgetc();
    if(c == -1)
    8000706c:	54fd                	li	s1,-1
    int c = uartgetc();
    8000706e:	00000097          	auipc	ra,0x0
    80007072:	fcc080e7          	jalr	-52(ra) # 8000703a <uartgetc>
    if(c == -1)
    80007076:	00950763          	beq	a0,s1,80007084 <uartintr+0x22>
      break;
    consoleintr(c);
    8000707a:	00000097          	auipc	ra,0x0
    8000707e:	8fe080e7          	jalr	-1794(ra) # 80006978 <consoleintr>
  while(1){
    80007082:	b7f5                	j	8000706e <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    80007084:	00020497          	auipc	s1,0x20
    80007088:	4c448493          	addi	s1,s1,1220 # 80027548 <uart_tx_lock>
    8000708c:	8526                	mv	a0,s1
    8000708e:	00000097          	auipc	ra,0x0
    80007092:	0b4080e7          	jalr	180(ra) # 80007142 <acquire>
  uartstart();
    80007096:	00000097          	auipc	ra,0x0
    8000709a:	e64080e7          	jalr	-412(ra) # 80006efa <uartstart>
  release(&uart_tx_lock);
    8000709e:	8526                	mv	a0,s1
    800070a0:	00000097          	auipc	ra,0x0
    800070a4:	156080e7          	jalr	342(ra) # 800071f6 <release>
}
    800070a8:	60e2                	ld	ra,24(sp)
    800070aa:	6442                	ld	s0,16(sp)
    800070ac:	64a2                	ld	s1,8(sp)
    800070ae:	6105                	addi	sp,sp,32
    800070b0:	8082                	ret

00000000800070b2 <initlock>:
}
#endif
...
initlock(struct spinlock *lk, char *name)
{
    ...
    800070b4:	e422                	sd	s0,8(sp)
    800070b6:	0800                	addi	s0,sp,16
  lk->name = name;
    800070b8:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    800070ba:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    800070be:	00053823          	sd	zero,16(a0)
#ifdef LAB_LOCK
  lk->nts = 0;
  lk->n = 0;
  findslot(lk);
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    800070c8:	411c                	lw	a5,0(a0)
    800070ca:	e399                	bnez	a5,800070d0 <holding+0x8>
    800070cc:	4501                	li	a0,0
  return r;
}
    800070ce:	8082                	ret
{
    ...
    800070d6:	e426                	sd	s1,8(sp)
    800070d8:	1000                	addi	s0,sp,32
  r = (lk->locked && lk->cpu == mycpu());
    800070da:	6904                	ld	s1,16(a0)
    800070dc:	ffffa097          	auipc	ra,0xffffa
    800070e0:	da8080e7          	jalr	-600(ra) # 80000e84 <mycpu>
    800070e4:	40a48533          	sub	a0,s1,a0
    800070e8:	00153513          	seqz	a0,a0
}
...
push_off(void)
{
    800070f6:	1101                	addi	sp,sp,-32
    800070f8:	ec06                	sd	ra,24(sp)
    800070fa:	e822                	sd	s0,16(sp)
    800070fc:	e426                	sd	s1,8(sp)
    800070fe:	1000                	addi	s0,sp,32
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    80007100:	100024f3          	csrr	s1,sstatus
    80007104:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    80007108:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    8000710a:	10079073          	csrw	sstatus,a5
  int old = intr_get();

  intr_off();
  if(mycpu()->noff == 0)
    8000710e:	ffffa097          	auipc	ra,0xffffa
    80007112:	d76080e7          	jalr	-650(ra) # 80000e84 <mycpu>
    80007116:	5d3c                	lw	a5,120(a0)
    80007118:	cf89                	beqz	a5,80007132 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    8000711a:	ffffa097          	auipc	ra,0xffffa
    8000711e:	d6a080e7          	jalr	-662(ra) # 80000e84 <mycpu>
    80007122:	5d3c                	lw	a5,120(a0)
    80007124:	2785                	addiw	a5,a5,1
    80007126:	dd3c                	sw	a5,120(a0)
}
    80007128:	60e2                	ld	ra,24(sp)
    8000712a:	6442                	ld	s0,16(sp)
    8000712c:	64a2                	ld	s1,8(sp)
    8000712e:	6105                	addi	sp,sp,32
    80007130:	8082                	ret
    mycpu()->intena = old;
    80007132:	ffffa097          	auipc	ra,0xffffa
    80007136:	d52080e7          	jalr	-686(ra) # 80000e84 <mycpu>
  return (x & SSTATUS_SIE) != 0;
    8000713a:	8085                	srli	s1,s1,0x1
    8000713c:	8885                	andi	s1,s1,1
    8000713e:	dd64                	sw	s1,124(a0)
    80007140:	bfe9                	j	8000711a <push_off+0x24>

0000000080007142 <acquire>:
{
    80007142:	1101                	addi	sp,sp,-32
    80007144:	ec06                	sd	ra,24(sp)
    80007146:	e822                	sd	s0,16(sp)
    80007148:	e426                	sd	s1,8(sp)
    8000714a:	1000                	addi	s0,sp,32
    8000714c:	84aa                	mv	s1,a0
  push_off(); // disable interrupts to avoid deadlock.
    8000714e:	00000097          	auipc	ra,0x0
    80007152:	fa8080e7          	jalr	-88(ra) # 800070f6 <push_off>
  if(holding(lk))
    80007156:	8526                	mv	a0,s1
    80007158:	00000097          	auipc	ra,0x0
    8000715c:	f70080e7          	jalr	-144(ra) # 800070c8 <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007160:	4705                	li	a4,1
  if(holding(lk))
    80007162:	e115                	bnez	a0,80007186 <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007164:	87ba                	mv	a5,a4
    80007166:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    8000716a:	2781                	sext.w	a5,a5
    8000716c:	ffe5                	bnez	a5,80007164 <acquire+0x22>
  __sync_synchronize();
    8000716e:	0ff0000f          	fence
  lk->cpu = mycpu();
    80007172:	ffffa097          	auipc	ra,0xffffa
    80007176:	d12080e7          	jalr	-750(ra) # 80000e84 <mycpu>
    8000717a:	e888                	sd	a0,16(s1)
}
    8000717c:	60e2                	ld	ra,24(sp)
    8000717e:	6442                	ld	s0,16(sp)
    80007180:	64a2                	ld	s1,8(sp)
    80007182:	6105                	addi	sp,sp,32
    80007184:	8082                	ret
    panic("acquire");
    80007186:	00002517          	auipc	a0,0x2
    8000718a:	6da50513          	addi	a0,a0,1754 # 80009860 <digits+0x20>
    8000718e:	00000097          	auipc	ra,0x0
    80007192:	a6a080e7          	jalr	-1430(ra) # 80006bf8 <panic>

0000000080007196 <pop_off>:

void
pop_off(void)
{
    80007196:	1141                	addi	sp,sp,-16
    80007198:	e406                	sd	ra,8(sp)
    8000719a:	e022                	sd	s0,0(sp)
    8000719c:	0800                	addi	s0,sp,16
  struct cpu *c = mycpu();
    8000719e:	ffffa097          	auipc	ra,0xffffa
    800071a2:	ce6080e7          	jalr	-794(ra) # 80000e84 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071a6:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    800071aa:	8b89                	andi	a5,a5,2
  if(intr_get())
    800071ac:	e78d                	bnez	a5,800071d6 <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    800071ae:	5d3c                	lw	a5,120(a0)
    800071b0:	02f05b63          	blez	a5,800071e6 <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    800071b4:	37fd                	addiw	a5,a5,-1
    800071b6:	0007871b          	sext.w	a4,a5
    800071ba:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    800071bc:	eb09                	bnez	a4,800071ce <pop_off+0x38>
    800071be:	5d7c                	lw	a5,124(a0)
    800071c0:	c799                	beqz	a5,800071ce <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071c2:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800071c6:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800071ca:	10079073          	csrw	sstatus,a5
    intr_on();
}
    800071ce:	60a2                	ld	ra,8(sp)
    800071d0:	6402                	ld	s0,0(sp)
    800071d2:	0141                	addi	sp,sp,16
    800071d4:	8082                	ret
    panic("pop_off - interruptible");
    800071d6:	00002517          	auipc	a0,0x2
    800071da:	69250513          	addi	a0,a0,1682 # 80009868 <digits+0x28>
    800071de:	00000097          	auipc	ra,0x0
    800071e2:	a1a080e7          	jalr	-1510(ra) # 80006bf8 <panic>
    panic("pop_off");
    800071e6:	00002517          	auipc	a0,0x2
    800071ea:	69a50513          	addi	a0,a0,1690 # 80009880 <digits+0x40>
    800071ee:	00000097          	auipc	ra,0x0
    800071f2:	a0a080e7          	jalr	-1526(ra) # 80006bf8 <panic>

00000000800071f6 <release>:
{
    800071f6:	1101                	addi	sp,sp,-32
    800071f8:	ec06                	sd	ra,24(sp)
    800071fa:	e822                	sd	s0,16(sp)
    800071fc:	e426                	sd	s1,8(sp)
    800071fe:	1000                	addi	s0,sp,32
    80007200:	84aa                	mv	s1,a0
  if(!holding(lk))
    80007202:	00000097          	auipc	ra,0x0
    80007206:	ec6080e7          	jalr	-314(ra) # 800070c8 <holding>
    8000720a:	c115                	beqz	a0,8000722e <release+0x38>
  lk->cpu = 0;
  ...
  pop_off();
    ...
    80007220:	f7a080e7          	jalr	-134(ra) # 80007196 <pop_off>
}
    80007224:	60e2                	ld	ra,24(sp)
    80007226:	6442                	ld	s0,16(sp)
    80007228:	64a2                	ld	s1,8(sp)
    8000722a:	6105                	addi	sp,sp,32
    8000722c:	8082                	ret
    panic("release");
    8000722e:	00002517          	auipc	a0,0x2
    80007232:	65a50513          	addi	a0,a0,1626 # 80009888 <digits+0x48>
    80007236:	00000097          	auipc	ra,0x0
    8000723a:	9c2080e7          	jalr	-1598(ra) # 80006bf8 <panic>

000000008000723e <lockfree_read8>:

// Read a shared 64-bit value without holding a lock
uint64
lockfree_read8(uint64 *addr) {
    8000723e:	1141                	addi	sp,sp,-16
    80007240:	e422                	sd	s0,8(sp)
    80007242:	0800                	addi	s0,sp,16
  uint64 val;
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    80007244:	0ff0000f          	fence
    80007248:	6108                	ld	a0,0(a0)
    8000724a:	0ff0000f          	fence
  return val;
}
    8000724e:	6422                	ld	s0,8(sp)
    80007250:	0141                	addi	sp,sp,16
    80007252:	8082                	ret

0000000080007254 <lockfree_read4>:

// Read a shared 32-bit value without holding a lock
int
lockfree_read4(int *addr) {
    80007254:	1141                	addi	sp,sp,-16
    80007256:	e422                	sd	s0,8(sp)
    80007258:	0800                	addi	s0,sp,16
  uint32 val;
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    8000725a:	0ff0000f          	fence
    8000725e:	4108                	lw	a0,0(a0)
    80007260:	0ff0000f          	fence
  return val;
}
    80007264:	2501                	sext.w	a0,a0
    80007266:	6422                	ld	s0,8(sp)
